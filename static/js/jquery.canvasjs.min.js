...
*/
(function(){function ma(h,m){h.prototype=ab(m.prototype);h.prototype.constructor=h;h.base=m.prototype}function ab(h){function m(){}m.prototype=h;return new m}function Ta(h,m,w){"millisecond"===w?h.setMilliseconds(h.getMilliseconds()+1*m):"second"===w?h.setSeconds(h.getSeconds()+1*m):"minute"===w?h.setMinutes(h.getMinutes()+1*m):"hour"===w?h.setHours(h.getHours()+1*m):"day"===w?h.setDate(h.getDate()+1*m):"week"===w?h.setDate(h.getDate()+7*m):"month"===w?h.setMonth(h.getMonth()+1*m):"year"===w&&h.setFullYear(h.getFullYear()+
1*m);return h}function Z(h,m){var w=!1;0>h&&(w=!0,h*=-1);h=""+h;for(m=m?m:1;h.length<m;)h="0"+h;return w?"-"+h:h}function Da(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var m=/\s/,w=h.length;m.test(h.charAt(--w)););return h.slice(0,w+1)}function za(h){h.roundRect=function(h,w,s,v,pa,E,y,F){y&&(this.fillStyle=y);F&&(this.strokeStyle=F);"undefined"===typeof pa&&(pa=5);this.lineWidth=E;this.beginPath();this.moveTo(h+pa,w);this.lineTo(h+s-pa,w);this.quadraticCurveTo(h+s,w,h+s,w+pa);this.lineTo(h+s,
w+v-pa);this.quadraticCurveTo(h+s,w+v,h+s-pa,w+v);this.lineTo(h+pa,w+v);this.quadraticCurveTo(h,w+v,h,w+v-pa);this.lineTo(h,w+pa);this.quadraticCurveTo(h,w,h+pa,w);this.closePath();y&&this.fill();F&&0<E&&this.stroke()}}function Na(h,m){return h-m}function Q(h){var m=((h&16711680)>>16).toString(16),w=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);m=2>m.length?"0"+m:m;w=2>w.length?"0"+w:w;h=2>h.length?"0"+h:h;return"#"+m+w+h}function bb(h,m){var w=this.length>>>0,s=Number(m)||0,s=0>s?Math.ceil(s):
Math.floor(s);for(0>s&&(s+=w);s<w;s++)if(s in this&&this[s]===h)return s;return-1}function s(h){return null===h||"undefined"===typeof h}function Aa(h){h.indexOf||(h.indexOf=bb);return h}function cb(h){if(J.fSDec)h[X("`eeDwdouMhrudods")](X("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){J._fTWm&&J._fTWm(h)})}function Ua(h,m,w){w=w||"normal";var s=h+"_"+m+"_"+w,v=Va[s];if(isNaN(v)){try{h="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+
h+"; font-size:"+m+"px; font-weight:"+w+";";if(!ua){var pa=document.body;ua=document.createElement("span");ua.innerHTML="";var E=document.createTextNode("Mpgyi");ua.appendChild(E);pa.appendChild(ua)}ua.style.display="";ua.setAttribute("style",h);v=Math.round(ua.offsetHeight);ua.style.display="none"}catch(y){v=Math.ceil(1.1*m)}v=Math.max(v,m);Va[s]=v}return v}function O(h,m){var w=[];if(w={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,
2],dashDot:[4,2,1,2],longDash:[8,2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var s=0;s<w.length;s++)w[s]*=m;else w=[];return w}function U(h,m,w,v,y){v=v||[];y=s(y)?db?{passive:!1,capture:!1}:!1:y;v.push([h,m,w,y]);return h.addEventListener?(h.addEventListener(m,w,y),w):h.attachEvent?(v=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};w.call(h,m)},h.attachEvent("on"+
m,v),v):!1}function eb(h){if(h._menuButton)h.exportEnabled?Ia(h._menuButton):sa(h._menuButton);else if(h.exportEnabled&&v){var m=!1;h._menuButton=document.createElement("button");ta(h,h._menuButton,"menu");h._toolBar.appendChild(h._menuButton);U(h._menuButton,"touchstart",function(h){m=!0},h.allDOMEventHandlers);U(h._menuButton,"click",function(){"none"!==h._dropdownMenu.style.display||h._dropDownCloseTime&&500>=(new Date).getTime()-h._dropDownCloseTime.getTime()||(h._dropdownMenu.style.display="block",
h._menuButton.blur(),h._dropdownMenu.focus())},h.allDOMEventHandlers,!0);U(h._menuButton,"mouseover",function(){m||(na(h._menuButton,{backgroundColor:h.toolbar.backgroundColorOnHover,color:h.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&na(h._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},h.allDOMEventHandlers,!0);U(h._menuButton,"mouseout",function(){m||(na(h._menuButton,{backgroundColor:h.toolbar.backgroundColor,color:h.toolbar.fontColor}),0>=
navigator.userAgent.search("MSIE")&&na(h._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},h.allDOMEventHandlers,!0)}if(!h._dropdownMenu&&h.exportEnabled&&v){m=!1;h._dropdownMenu=document.createElement("div");h._dropdownMenu.setAttribute("tabindex",-1);var w=-1!==h.theme.indexOf("dark")?"black":"#888888";h._dropdownMenu.style.cssText="position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:"+
h.toolbar.backgroundColor+";box-shadow: 2px 2px 10px "+w;h._dropdownMenu.style.display="none";h._toolBar.appendChild(h._dropdownMenu);U(h._dropdownMenu,"blur",function(){sa(h._dropdownMenu);h._dropDownCloseTime=new Date},h.allDOMEventHandlers,!0);w=document.createElement("div");w.style.cssText="padding: 12px 8px 12px 8px";w.innerHTML=h._cultureInfo.printText;w.style.backgroundColor=h.toolbar.backgroundColor;w.style.color=h.toolbar.fontColor;h._dropdownMenu.appendChild(w);U(w,"touchstart",function(h){m=
!0},h.allDOMEventHandlers);U(w,"mouseover",function(){m||(this.style.backgroundColor=h.toolbar.backgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0);U(w,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.backgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0);U(w,"click",function(){h.print();sa(h._dropdownMenu)},h.allDOMEventHandlers,!0);w=document.createElement("div");w.style.cssText="padding: 12px 8px 12px 8px";w.innerHTML=
h._cultureInfo.saveJPGText;w.style.backgroundColor=h.toolbar.backgroundColor;w.style.color=h.toolbar.fontColor;h._dropdownMenu.appendChild(w);U(w,"touchstart",function(h){m=!0},h.allDOMEventHandlers);U(w,"mouseover",function(){m||(this.style.backgroundColor=h.toolbar.backgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0);U(w,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.backgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,
!0);U(w,"click",function(){h.exportChart({format:"jpeg",fileName:h.exportFileName});sa(h._dropdownMenu)},h.allDOMEventHandlers,!0);w=document.createElement("div");w.style.cssText="padding: 12px 8px 12px 8px";w.innerHTML=h._cultureInfo.savePNGText;w.style.backgroundColor=h.toolbar.backgroundColor;w.style.color=h.toolbar.fontColor;h._dropdownMenu.appendChild(w);U(w,"touchstart",function(h){m=!0},h.allDOMEventHandlers);U(w,"mouseover",function(){m||(this.style.backgroundColor=h.toolbar.backgroundColorOnHover,
this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0);U(w,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.backgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0);U(w,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});sa(h._dropdownMenu)},h.allDOMEventHandlers,!0)}}function Wa(h,m,w){h*=ga;m*=ga;h=w.getImageData(h,m,2,2).data;m=!0;for(w=0;4>w;w++)if(h[w]!==h[w+4]|h[w]!==h[w+8]|h[w]!==h[w+12]){m=!1;break}return m?h[0]<<
16|h[1]<<8|h[2]:0}function ka(h,m,w){return h in m?m[h]:w[h]}function Ja(h,m,w){if(v&&Xa){var s=h.getContext("2d");Ka=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;ga=Oa/Ka;h.width=m*ga;h.height=w*ga;Oa!==Ka&&(h.style.width=m+"px",h.style.height=w+"px",s.scale(ga,ga))}else h.width=m,h.height=w}function fb(h){if(!gb){var m=!1,w=!1;"undefined"===typeof oa.Chart.creditHref?(h.creditHref=X("iuuqr;..b`ow`rkr/bnl."),
...
h._creditLink.setAttribute("tabIndex",-1),h._creditLink.setAttribute("target","_blank"));if(0===h.renderCount||m||w)h._creditLink.setAttribute("href",h.creditHref),h._creditLink.innerHTML=h.creditText;h._creditLink&&h.creditHref&&h.creditText?(h._creditLink.parentElement||h._canvasJSContainer.appendChild(h._creditLink),h._creditLink.style.top=h.height-14+"px"):h._creditLink.parentElement&&h._canvasJSContainer.removeChild(h._creditLink)}}}function ra(h,m){Ea&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
var w=document.createElement("canvas");w.setAttribute("class","canvasjs-chart-canvas");Ja(w,h,m);v||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(w);return w}function na(h,m){for(var w in m)h.style[w]=m[w]}function ta(h,m,w){m.getAttribute("state")||(m.style.backgroundColor=h.toolbar.backgroundColor,m.style.color=h.toolbar.fontColor,m.style.border="none",na(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
w&&(m.setAttribute("state",w),m.setAttribute("type","button"),na(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.setAttribute("title",h._cultureInfo[w+"Text"]),m.innerHTML="<img style='height:95%; pointer-events: none;' src='"+hb[w].image+"' alt='"+h._cultureInfo[w+"Text"]+"' />")}function Ia(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function sa(){for(var h=
null,m=0;m<arguments.length;m++)(h=arguments[m])&&h.style&&(h.style.display="none")}function Pa(h,m,w,s,v){if(null===h||"undefined"===typeof h)return"undefined"===typeof w?m:w;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?m/100:1);"undefined"!==typeof s&&(h=Math.min(s,h),"undefined"!==typeof v&&(h=Math.max(v,h)));return!isNaN(h)&&h<=m&&0<=h?h:"undefined"===typeof w?m:w}function V(h,m,w,v,y){this._defaultsKey=h;this._themeOptionsKey=m;this._index=v;this.parent=y;this._eventListeners=[];
...
typeof v&&(v=0);this._padding=v;this._x1=h;this._y1=m;this._x2=w;this._y2=s;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ia(h,m){ia.base.constructor.call(this,"TextBlock",null,m,null,null);this.ctx=h;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Qa(h,m){Qa.base.constructor.call(this,"Toolbar","toolbar",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="toolbar"}function wa(h,m){wa.base.constructor.call(this,
...
(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.height=this.width=null;this.bounds={x1:null,y1:null,x2:null,y2:null}}function Fa(h,m,w){Fa.base.constructor.call(this,"Subtitle","subtitles",m,w,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="subtitles";this.isOptionsInArray=!0;"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.height=this.width=null;this.bounds={x1:null,y1:null,x2:null,y2:null}}function Ra(){this.pool=
[]}function Ga(h){var m;h&&Ha[h]&&(m=Ha[h]);Ga.base.constructor.call(this,"CultureInfo",null,m,null,null)}var Ea=!1,J={},v=!!document.createElement("canvas").getContext,oa={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",rangeChanging:null,
...
cornerRadius:0,backgroundColor:v?"transparent":null,margin:5,wrap:!0,maxWidth:null,dockInsidePlotArea:!1,publicProperties:{options:"readWrite",bounds:"readOnly",chart:"readOnly"}},Subtitle:{padding:0,text:null,verticalAlign:"top",horizontalAlign:"center",fontSize:14,fontFamily:"Calibri",fontWeight:"normal",fontColor:"black",fontStyle:"normal",borderThickness:0,borderColor:"black",cornerRadius:0,backgroundColor:null,margin:2,wrap:!0,maxWidth:null,dockInsidePlotArea:!1,publicProperties:{options:"readWrite",
...
digitGroupSeparator:",",zoomText:"Zoom",panText:"Pan",resetText:"Reset",menuText:"More Options",saveJPGText:"Save as JPEG",savePNGText:"Save as PNG",printText:"Print",days:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),shortDays:"Sun Mon Tue Wed Thu Fri Sat".split(" "),months:"January February March April May June July August September October November December".split(" "),shortMonths:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")}},Ha={en:{}},y=v?"Trebuchet MS, Helvetica, sans-serif":
"Arial",Ca=v?"Impact, Charcoal, sans-serif":"Arial",xa={colorSet1:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),colorSet2:"#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},H,$,S,da,ha;$="#333333";S="#000000";H="#666666";
ha=da="#000000";var T=20,F=14,Sa={colorSet:"colorSet1",backgroundColor:"#FFFFFF",title:{fontFamily:Ca,fontSize:32,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Ca,fontSize:F,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:y,indexLabelFontSize:F,indexLabelFontColor:$,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,
labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",
lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",
labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",
labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",
...
fontSize:14,fontColor:$,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1}};S=$="#F5F5F5";H="#FFFFFF";da="#40BAF1";ha="#F5F5F5";var T=20,F=14,Ya={colorSet:"colorSet2",title:{fontFamily:y,fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},subtitles:[{fontFamily:y,fontSize:F,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:y,
...
color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",
...
titleFontSize:T,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",
labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:F,
...
fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1}};S=$="#F5F5F5";H="#FFFFFF";da="#40BAF1";ha="#F5F5F5";T=20;F=14;Ca={colorSet:"colorSet12",backgroundColor:"#2A2A2A",title:{fontFamily:Ca,fontSize:32,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Ca,fontSize:F,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{backgroundColor:"#666666",backgroundColorOnHover:"#FF7372",borderColor:"#FF7372",borderThickness:1,fontColor:"#F5F5F5",
fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:y,indexLabelFontSize:F,indexLabelFontColor:S,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,
color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,
tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:y,titleFontSize:T,
titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},
scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],
crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:y,fontSize:14,fontColor:$,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:S,backgroundColor:"rgba(0, 0, 0, .7)"}};
H="#FFFFFF";S=$="#FAFAFA";da="#40BAF1";ha="#F5F5F5";var T=20,F=14,Za={light1:Sa,light2:Ya,dark1:Ca,dark2:{colorSet:"colorSet2",backgroundColor:"#32373A",title:{fontFamily:y,fontSize:32,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:y,fontSize:F,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{backgroundColor:"#666666",backgroundColorOnHover:"#FF7372",borderColor:"#FF7372",borderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},
data:[{indexLabelFontFamily:y,indexLabelFontSize:F,indexLabelFontColor:S,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",
thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,
gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,
titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:0,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",
spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:0,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,
...
theme2:Ya,theme3:Sa},R={numberDuration:1,yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(function(){J.fSDec=function(h){for(var m="",w=0;w<h.length;w++)m+=String.fromCharCode(h[w]-111);return m};J.str={ncv:[189,222,221,156,178,222,220,220,212,225,210,216,208,219,143,197,212,225,226,216,222,221],fntStr:[223,
...
227])][J.fSDec([210,225,212,211,216,227,183,225,212,213])];J.pro={sCH:oa[J.fSDec([178,215,208,225,227])][J.fSDec([210,225,212,211,216,227,183,225,212,213])]};J._fTWm=function(h){if("undefined"===typeof J.pro.sCH&&!$a){var m=h[J.fSDec(J.str.ct)];m[J.fSDec(J.str.tBl)]=J.fSDec(J.str.tp);m[J.fSDec(J.str.fnt)]=11+J.fSDec(J.str.fntStr);m[J.fSDec(J.str.fSy)]=J.fSDec(J.str.gr);m[J.fSDec(J.str.fTx)](J.fSDec(J.str.ncv),2,h.height-11-2)}}})();var db=function(){var h=!1;try{var m=Object.defineProperty&&Object.defineProperty({},
"passive",{get:function(){h=!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,m),window.removeEventListener("test",null,m))}catch(w){h=!1}return h}(),Va={},ua=null,ib=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},jb=function(h,m,w){m=Math.min(this.width,this.height);return Math.max("theme4"===this.theme?0:300<=m?12:11,Math.round(m*(h/400)))},ya=function(){var h=
...
E=/[^-+\dA-Z]/g;return function(F,O,N){var H=N?N.days:m,Q=N?N.months:s,U=N?N.shortDays:w,R=N?N.shortMonths:v;N="";var J=!1;F=F&&F.getTime?F:F?new Date(F):new Date;if(isNaN(F))throw SyntaxError("invalid date");"UTC:"===O.slice(0,4)&&(O=O.slice(4),J=!0);N=J?"getUTC":"get";var V=F[N+"Date"](),L=F[N+"Day"](),W=F[N+"Month"](),a=F[N+"FullYear"](),d=F[N+"Hours"](),c=F[N+"Minutes"](),b=F[N+"Seconds"](),e=F[N+"Milliseconds"](),f=J?0:F.getTimezoneOffset();return N=O.replace(h,function(l){switch(l){case "D":return V;
case "DD":return Z(V,2);case "DDD":return U[L];case "DDDD":return H[L];case "M":return W+1;case "MM":return Z(W+1,2);case "MMM":return R[W];case "MMMM":return Q[W];case "Y":return parseInt(String(a).slice(-2));case "YY":return Z(String(a).slice(-2),2);case "YYY":return Z(String(a).slice(-3),3);case "YYYY":return Z(a,4);case "h":return d%12||12;case "hh":return Z(d%12||12,2);case "H":return d;case "HH":return Z(d,2);case "m":return c;case "mm":return Z(c,2);case "s":return b;case "ss":return Z(b,2);
case "f":return String(e).slice(0,1);case "ff":return Z(String(e).slice(0,2),2);case "fff":return Z(String(e).slice(0,3),3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return J?"UTC":(String(F).match(y)||[""]).pop().replace(E,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+Z(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+Z(Math.floor(Math.abs(f)/60),2)+Z(Math.abs(f)%
60,2);default:return l.slice(1,l.length-1)}})}}(),ea=function(h,m,w){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var s=0>h?!0:!1;s&&(h*=-1);var v=w?w.decimalSeparator:".",y=w?w.digitGroupSeparator:",",E="";m=String(m);var E=1,F=w="",O=-1,N=[],H=[],Q=0,J=0,U=0,R=!1,V=0,F=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var L=0;F&&L<F.length;L++)if(m=F[L],"."===m&&0>O)O=L;else{if("%"===m)E*=100;else if("\u2030"===m){E*=1E3;continue}else if(","===m[0]&&"."===m[m.length-
1]){E/=Math.pow(1E3,m.length-1);O=L+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(R=!0);0>O?(N.push(m),"#"===m||"0"===m?Q++:","===m&&U++):(H.push(m),"#"!==m&&"0"!==m||J++)}R&&(m=Math.floor(h),F=-Math.floor(Math.log(h)/Math.LN10+1),V=0===h?0:0===m?-(Q+F):String(m).length-Q,E/=Math.pow(10,V));0>O&&(O=L);E=(h*E).toFixed(J);m=E.split(".");E=(m[0]+"").split("");h=(m[1]+"").split("");E&&"0"===E[0]&&E.shift();for(R=F=L=J=O=0;0<N.length;)if(m=N.pop(),"#"===m||"0"===m)if(O++,O===Q){var W=
E,E=[];if("0"===m)for(m=Q-J-(W?W.length:0);0<m;)W.unshift("0"),m--;for(;0<W.length;)w=W.pop()+w,R++,0===R%F&&(L===U&&0<W.length)&&(w=y+w)}else 0<E.length?(w=E.pop()+w,J++,R++):"0"===m&&(w="0"+w,J++,R++),0===R%F&&(L===U&&0<E.length)&&(w=y+w);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(L++,F=R,R=0,0<E.length&&(w=y+w)):w=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+w:m+w:(m=0>V?m.replace("+","").replace("-",
""):m.replace("-",""),w+=m.replace(/[0]+/,function(a){return Z(V,a.length)}));y="";for(N=!1;0<H.length;)m=H.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(y+=h.shift(),N=!0):"0"===m&&(y+="0",N=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?y+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?y+=m:(m=0>V?m.replace("+","").replace("-",""):m.replace("-",""),y+=m.replace(/[0]+/,function(a){return Z(V,a.length)}));
w+=(N?v:"")+y;return s?"-"+w:w},La=function(h){var m=0,w=0;h=h||window.event;h.offsetX||0===h.offsetX?(m=h.offsetX,w=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,w=h.layerY):(m=h.pageX-h.target.offsetLeft,w=h.pageY-h.target.offsetTop);return{x:m,y:w}},Xa=!0,Oa=window.devicePixelRatio||1,Ka=1,ga=Xa?Oa/Ka:1,ca=function(h,m,w,s,v,y,E,F,O,N,R,Q,H){"undefined"===typeof H&&(H=1);E=E||0;F=F||"black";var J=15<s-m&&15<v-w?8:0.35*Math.min(s-m,v-w);h.beginPath();h.moveTo(m,w);h.save();h.fillStyle=y;h.globalAlpha=
H;h.fillRect(m,w,s-m,v-w);h.globalAlpha=1;0<E&&(H=0===E%2?0:0.5,h.beginPath(),h.lineWidth=E,h.strokeStyle=F,h.moveTo(m,w),h.rect(m-H,w-H,s-m+2*H,v-w+2*H),h.stroke());h.restore();!0===O&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+J,w+J),h.lineTo(s-J,w+J),h.lineTo(s,w),h.closePath(),E=h.createLinearGradient((s+m)/2,w+J,(s+m)/2,w),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===N&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+J,v-J),h.lineTo(s-
J,v-J),h.lineTo(s,v),h.closePath(),E=h.createLinearGradient((s+m)/2,v-J,(s+m)/2,v),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===R&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+J,w+J),h.lineTo(m+J,v-J),h.lineTo(m,v),h.closePath(),E=h.createLinearGradient(m+J,(v+w)/2,m,(v+w)/2),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.restore());!0===Q&&(h.save(),h.beginPath(),h.moveTo(s,w),h.lineTo(s-J,
w+J),h.lineTo(s-J,v-J),h.lineTo(s,v),E=h.createLinearGradient(s-J,(v+w)/2,s,(v+w)/2),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.closePath(),h.restore())},X=function(h){for(var m="",s=0;s<h.length;s++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(s));return m},$a=window&&window[X("mnb`uhno")]&&window[X("mnb`uhno")].href&&window[X("mnb`uhno")].href.indexOf&&(-1!==
window[X("mnb`uhno")].href.indexOf(X("b`ow`rkr/bnl"))||-1!==window[X("mnb`uhno")].href.indexOf(X("gdonqhy/bnl"))||-1!==window[X("mnb`uhno")].href.indexOf(X("gheemd"))),gb=$a&&-1===window[X("mnb`uhno")].href.indexOf(X("gheemd")),hb={reset:{image:"data:image/png;base64,"},
...
m=s):m=void 0,h[m]=this.options};V.prototype.remove=function(h){h="undefined"===typeof h?!0:h;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Aa(m);var s=m.indexOf(this.options);0<=s&&m.splice(s,1)}else delete this.parent.options[this.optionsName];h&&(this.stockChart||this.chart||this).render()};V.prototype.updateOption=function(h){!oa[this._defaultsKey]&&(Ea&&window.console)&&console.log("defaults not set");var m=oa[this._defaultsKey],v={},y=this[h],F=this._themeOptionsKey,
J=this._index;this.theme&&s(this.parent)&&s(F)&&s(J)?v=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[F])&&(null===J?v=this.parent.themeOptions[F]:0<this.parent.themeOptions[F].length&&(v=Math.min(this.parent.themeOptions[F].length-1,J),v=this.parent.themeOptions[F][v]));this.themeOptions=v;h in m&&(y=h in this.options?this.options[h]:v&&h in v?v[h]:m[h]);if(y===this[h])return!1;this[h]=
...
function(){return{x1:this._x1+this._leftOccupied,y1:this._y1+this._topOccupied,x2:this._x2-this._rightOccupied,y2:this._y2-this._bottomOccupied,width:this._x2-this._x1-this._rightOccupied-this._leftOccupied,height:this._y2-this._y1-this._bottomOccupied-this._topOccupied}};Ba.prototype.reset=function(){this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding};ma(ia,V);ia.prototype._initialize=function(){s(this.padding)||"object"!==typeof this.padding?this.topPadding=
...
null};ia.prototype.measureText=function(){this._lineHeight=Ua(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ia.prototype._getLineWithWidth=function(h,m,s){h=String(h);if(!h)return{text:"",width:0};var v=s=0,y=h.length-1,F=Infinity;for(this.ctx.font=this._getFontString();v<=y;){var F=Math.floor((v+y)/2),E=h.substr(0,F+1);s=this.ctx.measureText(E).width;
if(s<m)v=F+1;else if(s>m)y=F-1;else break}s>m&&1<E.length&&(E=E.substr(0,E.length-1),s=this.ctx.measureText(E).width);m=!0;if(E.length===h.length||" "===h[E.length])m=!1;m&&(h=E.split(" "),1<h.length&&h.pop(),E=h.join(" "),s=this.ctx.measureText(E).width);return{text:E,width:s}};ia.prototype._wrapText=function(){var h=new String(Da(String(this.text))),m=[],s=this.ctx.font,v=0,y=0;this.ctx.font=this._getFontString();if(0===this.frontSize)y=v=0;else for(;0<h.length;){var F=this.maxHeight-(this.topPadding+
this.bottomPadding),E=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);E.height=this._lineHeight;m.push(E);var J=y,y=Math.max(y,E.width),v=v+E.height,h=Da(h.slice(E.text.length,h.length));F&&v>F&&(E=m.pop(),v-=E.height,y=J)}this._wrappedText={lines:m,width:y,height:v};this.width=y+(this.leftPadding+this.rightPadding);this.height=v+(this.topPadding+this.bottomPadding);this.ctx.font=s};ia.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!v&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return h+=m};ma(Qa,V);ma(wa,V);wa.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),v=m.x1,y=m.y1,F=0,J=0,E=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,O,H;"top"===this.verticalAlign||
"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=m.width-4-E*("center"===this.horizontalAlign?2:1)),J=0.5*m.height-this.margin-2,F=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=m.height-4),J=0.5*m.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=m.width-4),J=0.5*m.height-4));var N;s(this.padding)||"number"!==typeof this.padding?s(this.padding)||"object"!==
...
backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,maxHeight:J,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"top"});N=J.measureText();"top"===this.verticalAlign||"bottom"===this.verticalAlign?("top"===this.verticalAlign?(y=m.y1+2,H="top"):"bottom"===this.verticalAlign&&(y=m.y2-2-N.height,H="bottom"),"left"===this.horizontalAlign?v=m.x1+2:"center"===this.horizontalAlign?v=m.x1+m.width/2-N.width/2:"right"===this.horizontalAlign&&(v=m.x2-2-N.width-E),O=this.horizontalAlign,
this.width=N.width,this.height=N.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(v=m.x1+2,y=m.y2-2-(this.maxWidth/2-N.width/2),F=-90,H="left",this.width=N.height,this.height=N.width):"right"===this.horizontalAlign?(v=m.x2-2,y=m.y1+2+(this.maxWidth/2-N.width/2),F=90,H="right",this.width=N.height,this.height=N.width):"center"===this.horizontalAlign&&(y=h.y1+(h.height/2-N.height/2),v=h.x1+(h.width/2-N.width/2),H="center",this.width=N.width,this.height=N.height),O="center");J.x=
v;J.y=y;J.angle=F;J.horizontalAlign=O;this._textBlock=J;h.layoutManager.registerSpace(H,{width:this.width+("left"===H||"right"===H?this.margin+2:0),height:this.height+("top"===H||"bottom"===H?this.margin+2:0)});this.bounds={x1:v,y1:y,x2:v+this.width,y2:y+this.height};this.ctx.textBaseline="top"}};wa.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};ma(Fa,V);Fa.prototype.setLayout=wa.prototype.setLayout;Fa.prototype.render=wa.prototype.render;Ra.prototype.get=function(h,m){var v=
null;0<this.pool.length?(v=this.pool.pop(),Ja(v,h,m)):v=ra(h,m);return v};Ra.prototype.release=function(h){this.pool.push(h)};ma(Ga,V);var Ma={addTheme:function(h,m){Za[h]=m},addColorSet:function(h,m){xa[h]=m},addCultureInfo:function(h,m){Ha[h]=m},formatNumber:function(h,m,v){v=v||"en";if(Ha[v])return ea(h,m||"#,##0.##",new Ga(v));throw"Unknown Culture Name";},formatDate:function(h,m,v){v=v||"en";if(Ha[v])return ya(h,m||"DD MMM YYYY",new Ga(v));throw"Unknown Culture Name";}};"undefined"!==typeof module&&
"undefined"!==typeof module.exports?module.exports=Ma:"function"===typeof define&&define.amd?define([],function(){return Ma}):(window.CanvasJS&&window.console&&window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."),window.CanvasJS=window.CanvasJS?window.CanvasJS:Ma);y=Ma.Chart=function(){function h(a,d){return a.x-d.x}function m(a,d,c){d=d||{};s(c)?(this.predefinedThemes=Za,this.optionsName=
...
0;this._lastTouchEventType="";this._lastTouchData=null;this.isAnimating=!1;this.renderCount=0;this.disableToolTip=this.animatedRender=!1;this.canvasPool=new Ra;this.allDOMEventHandlers=[];this.panEnabled=!1;this._defaultCursor="default";this.plotArea={canvas:null,ctx:null,x1:0,y1:0,x2:0,y2:0,width:0,height:0};this._dataInRenderedOrder=[];(this.container="string"===typeof this._containerId?document.getElementById(this._containerId):this._containerId)?(this.container.innerHTML="",d=a=0,a=this.options.width?
...
2+1;var z=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[u].x>a[f].x&&0<z||a[u].x<a[f].x&&0>z?{x:a[u].x+z/3,y:a[u].y+b/3}:{x:a[u].x,y:a[u].y+b/9};u=e;f=0===u?0:u-1;l=u===a.length-1?u:u+1;b=Math.abs((a[l].x-a[f].x)/(0===a[u].x-a[f].x?0.01:a[u].x-a[f].x))*(d-1)/2+1;z=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[u].x>a[f].x&&0<z||a[u].x<a[f].x&&0>z?{x:a[u].x-z/3,y:a[u].y-b/3}:{x:a[u].x,y:a[u].y-b/9};c[c.length]=a[e]}return c}function y(a,d,c,b,e,f,l,u,z,k){var n=0;k?(l.color=f,u.color=f):
k=1;n=z?Math.abs(e-c):Math.abs(b-d);n=0<l.trimLength?Math.abs(n*l.trimLength/100):Math.abs(n-l.length);z?(c+=n/2,e-=n/2):(d+=n/2,b-=n/2);var n=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(u.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=u.color||f;a.lineWidth=u.thickness||2;a.setLineDash&&a.setLineDash(O(u.dashType,u.thickness));a.beginPath();z&&0<u.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):0<u.thickness&&(a.moveTo(Math.round((d+
b)/2)-p,c+l.thickness/2),a.lineTo(Math.round((d+b)/2)-p,e-l.thickness/2));a.stroke();a.strokeStyle=l.color||f;a.lineWidth=l.thickness||2;a.setLineDash&&a.setLineDash(O(l.dashType,l.thickness));a.beginPath();z&&0<l.thickness?(a.moveTo(b-n,c),a.lineTo(b-n,e),a.moveTo(d+n,c),a.lineTo(d+n,e)):0<l.thickness&&(a.moveTo(d,c+n),a.lineTo(b,c+n),a.moveTo(d,e-n),a.lineTo(b,e-n));a.stroke();a.restore()}function F(a,d){F.base.constructor.call(this,"Legend","legend",d,null,a);this.chart=a;this.canvas=a.canvas;
this.ctx=this.chart.ctx;this.ghostCtx=this.chart._eventManager.ghostCtx;this.items=[];this.optionsName="legend";this.height=this.width=0;this.orientation=null;this.dataSeries=[];this.bounds={x1:null,y1:null,x2:null,y2:null};"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.lineHeight=Ua(this.fontFamily,this.fontSize,this.fontWeight);this.horizontalSpacing=this.fontSize}function H(a,d,c,b){H.base.constructor.call(this,"DataSeries","data",d,c,
...
this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=0;a<this.options.stripLines.length;a++)this.stripLines.push(new N(this.chart,this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new $(this.chart,this.options.crosshair,this));this._titleTextBlock=null;this.hasOptionChanged("viewportMinimum")&&null===this.viewportMinimum&&(this.options.viewportMinimum=void 0,this.sessionVariables.viewportMinimum=
...
this.startValue)+(this.endValue.getTime?this.endValue.getTime():this.endValue))/2,this._thicknessType=null)}function $(a,d,c){$.base.constructor.call(this,"Crosshair","crosshair",d,null,c);this.chart=a;this.ctx=this.chart.ctx;this.axis=c;this.optionsName="crosshair";this._thicknessType="pixel"}function Z(a,d){Z.base.constructor.call(this,"ToolTip","toolTip",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=
NaN;this.containerTransitionDuration=0.1;this.mozContainerTransition=this.getContainerTransition(this.containerTransitionDuration);this.optionsName="toolTip";this._initialize()}function da(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCanvas=ra(this.chart.width,this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function ha(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;
this.animations=[];this.animationRequestId=null}ma(m,V);m.prototype.destroy=function(){var a=this.allDOMEventHandlers;this._animator&&this._animator.cancelAllAnimations();this._panTimerId&&clearTimeout(this._panTimerId);for(var d=0;d<a.length;d++){var c=a[d][0],b=a[d][1],e=a[d][2],f=a[d][3],f=f||!1;c.removeEventListener?c.removeEventListener(b,e,f):c.detachEvent&&c.detachEvent("on"+b,e)}this.allDOMEventHandlers=[];for(this.removeAllEventListeners();this._canvasJSContainer&&this._canvasJSContainer.hasChildNodes();)this._canvasJSContainer.removeChild(this._canvasJSContainer.lastChild);
...
new Ga(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&v;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");if(this.options.zoomEnabled||this.panEnabled){if(!this._zoomButton){var d=!1;sa(this._zoomButton=document.createElement("button"));ta(this,this._zoomButton,"pan");this._toolBar.appendChild(this._zoomButton);
this._zoomButton.style.borderRight=this.toolbar.borderThickness+"px solid "+this.toolbar.borderColor;U(this._zoomButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers);U(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,ta(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,ta(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);U(this._zoomButton,"mouseover",function(){d?d=!1:(na(a._zoomButton,{backgroundColor:a.toolbar.backgroundColorOnHover,
color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&na(a._zoomButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);U(this._zoomButton,"mouseout",function(){d||(na(a._zoomButton,{backgroundColor:a.toolbar.backgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&na(a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},
this.allDOMEventHandlers)}this._resetButton||(d=!1,sa(this._resetButton=document.createElement("button")),ta(this,this._resetButton,"reset"),this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.borderThickness:0)+"px solid "+this.toolbar.borderColor,this._toolBar.appendChild(this._resetButton),U(this._resetButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers),U(this._resetButton,"click",function(){a.toolTip.hide();a.toolTip.dispatchEvent("hidden",{chart:a,toolTip:a.toolTip},
...
a.stockChart._rangeEventParameter,a.stockChart))},this.allDOMEventHandlers),U(this._resetButton,"mouseover",function(){d||(na(a._resetButton,{backgroundColor:a.toolbar.backgroundColorOnHover,color:a.toolbar.hoverFfontColorOnHoverontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&na(a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers),U(this._resetButton,"mouseout",function(){d||(na(a._resetButton,{backgroundColor:a.toolbar.backgroundColor,
color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&na(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers),this.overlaidCanvas.style.cursor=a._defaultCursor);this.zoomEnabled||this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),Ia(a._zoomButton,a._resetButton)):
(this.zoomEnabled=!0,this.panEnabled=!1))}else this.panEnabled=this.zoomEnabled=!1;eb(this);"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?ta(a,a._zoomButton,"zoom"):ta(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&ta(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=this.options.toolTip);for(var c in this.toolTip.options)this.toolTip.options.hasOwnProperty(c)&&this.toolTip.updateOption(c)};
m.prototype._updateSize=function(){var a;a=[this.canvas,this.overlaidCanvas,this._eventManager.ghostCanvas];var d=0,c=0;this.options.width?d=this.width:this.width=d=0<this.container.clientWidth?this.container.clientWidth:this.width;this.options.height?c=this.height:this.height=c=0<this.container.clientHeight?this.container.clientHeight:this.height;if(this.canvas.width!==d*ga||this.canvas.height!==c*ga){for(var b=0;b<a.length;b++)Ja(a[b],d,c);this.bounds={x1:0,y1:0,x2:this.width,y2:this.height,width:this.width,
height:this.height};a=!0}else a=!1;return a};m.prototype._initialize=function(){this.isNavigator=s(this.parent)||s(this.parent._defaultsKey)||"Navigator"!==this.parent._defaultsKey?!1:!0;this.toolbar=new Qa(this,this.options.toolbar);this._animator?this._animator.cancelAllAnimations():this._animator=new ha(this);this.removeAllEventListeners();this.disableToolTip=!1;this._axes=[];this.funnelPyramidClickHandler=this.pieDoughnutClickHandler=null;this._updateOptions();this.animatedRender=v&&this.animationEnabled&&
0===this.renderCount;this._updateSize();this.clearCanvas();this.ctx.beginPath();this.axisX=[];this.axisX2=[];this.axisY=[];this.axisY2=[];this._indexLabels=[];this._dataInRenderedOrder=[];this._events=[];this._eventManager&&this._eventManager.reset();this.plotInfo={axisPlacement:null,plotTypes:[]};this.layoutManager=new Ba(0,0,this.width,this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];var a=0,d=null;if(this.options.data){for(var c=0;c<
...
"undefined"===typeof this.axisX2[0].options.gridThickness?this.axisX2[0].gridThickness=0:0<this.axisX2[0].gridThickness&&"undefined"===typeof this.axisX[0].options.gridThickness&&(this.axisX[0].gridThickness=0));c=!1;if(0<this._axes.length&&this.options.zoomEnabled&&(this.zoomEnabled||this.panEnabled))for(d=0;d<this._axes.length;d++)if(null!==this._axes[d].viewportMinimum||null!==this._axes[d].viewportMaximum){c=!0;break}c?(Ia(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.borderThickness+
"px solid "+this.toolbar.borderColor,this._zoomButton.style.borderRight=this.toolbar.borderThickness+"px solid "+this.toolbar.borderColor,this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.borderThickness:0)+"px solid "+this.toolbar.borderColor):(sa(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.borderThickness+"px solid transparent",this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));cb(this);this._processData();this.options.title&&(this.title=
new wa(this,this.options.title),this.title.dockInsidePlotArea?a.push(this.title):this.title.setLayout());this.subtitles=[];if(this.options.subtitles)for(d=0;d<this.options.subtitles.length;d++)c=new Fa(this,this.options.subtitles[d],d),this.subtitles.push(c),c.dockInsidePlotArea?a.push(c):c.setLayout();this.legend=new F(this,this.options.legend);for(d=0;d<this.data.length;d++)(this.data[d].showInLegend||"pie"===this.data[d].type||"doughnut"===this.data[d].type||"funnel"===this.data[d].type||"pyramid"===
this.data[d].type)&&this.legend.dataSeries.push(this.data[d]);this.legend.dockInsidePlotArea?a.push(this.legend):this.legend.setLayout();for(d=0;d<this._axes.length;d++)if(this._axes[d].scaleBreaks&&this._axes[d].scaleBreaks._appliedBreaks.length){v?(this._breaksCanvas=ra(this.width,this.height,!0),this._breaksCanvasCtx=this._breaksCanvas.getContext("2d")):(this._breaksCanvas=this.canvas,this._breaksCanvasCtx=this.ctx);break}this._preRenderCanvas=ra(this.width,this.height);this._preRenderCtx=this._preRenderCanvas.getContext("2d");
...
this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement)E.render(this.axisX,this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement);else if("none"===this.plotInfo.axisPlacement)this.preparePlotArea();else return;for(d=0;d<a.length;d++)a[d].setLayout(),a[d].render();var c=[];if(this.animatedRender){var b=ra(this.width,this.height);b.getContext("2d").drawImage(this.canvas,0,0,this.width,this.height)}fb(this);var a=this.ctx.miterLimit,e;this.ctx.miterLimit=3;v&&this._breaksCanvas&&
...
for(var k=0;k<u.dataSeriesIndexes.length;k++)this._dataInRenderedOrder.push(this.data[u.dataSeriesIndexes[k]]);this.animatedRender&&(u.targetCanvasCtx.miterLimit=e,z&&c.push(z))}this.ctx.miterLimit=a;this.animatedRender&&this._breaksCanvasCtx&&c.push({source:this._breaksCanvasCtx,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0,startTimePercent:0.7});this.animatedRender&&0<this._indexLabels.length&&(e=ra(this.width,this.height).getContext("2d"),
...
{chart:n});n.dispatchEvent("dataAnimationEnd",{chart:n})}this.attachPlotAreaEventHandlers();this.zoomEnabled||(this.panEnabled||!this._zoomButton||"none"===this._zoomButton.style.display)||sa(this._zoomButton,this._resetButton);this.toolTip._updateToolTip();this.renderCount++;Ea&&(n=this,setTimeout(function(){var a=document.getElementById("ghostCanvasCopy");a&&(Ja(a,n.width,n.height),a.getContext("2d").drawImage(n._eventManager.ghostCanvas,0,0))},2E3));this._breaksCanvas&&(delete this._breaksCanvas,
...
this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(u.dataPoints[z].x&&u.dataPoints[z].x.getTime||"dateTime"===u.xValueType)f=!0;for(z=0;z<u.dataPoints.length;z++){"undefined"===typeof u.dataPoints[z].x&&(u.dataPoints[z].x=z+(a.axisX.logarithmic?1:0));u.dataPoints[z].x.getTime?(f=!0,b=u.dataPoints[z].x.getTime()):b=u.dataPoints[z].x;e=u.dataPoints[z].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);e<d.min&&"number"===typeof e&&(d.min=e);e>d.max&&"number"===typeof e&&(d.max=e);if(0<z){if(a.axisX.logarithmic){var r=
b/u.dataPoints[z-1].x;1>r&&(r=1/r);c.minDiff>r&&1!==r&&(c.minDiff=r)}else r=b-u.dataPoints[z-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r);null!==e&&null!==u.dataPoints[z-1].y&&(a.axisY.logarithmic?(r=e/u.dataPoints[z-1].y,1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e-u.dataPoints[z-1].y,0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<z)){z-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;u.dataPoints[z].label&&(a.axisX.labels[b]=u.dataPoints[z].label);
b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&p<b&&(c.viewPortMin=p):(e<d.viewPortMin&&"number"===typeof e&&(d.viewPortMin=e),e>d.viewPortMax&&"number"===typeof e&&(d.viewPortMax=e))}}u.axisX.valueType=u.xValueType=f?"dateTime":"number"}};m.prototype._processStackedPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=[],u=[],z=Infinity,k=-Infinity,n=0;n<a.dataSeriesIndexes.length;n++){var p=
...
p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&h<b&&(c.viewPortMin=h):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,z=Math.min(e,z)):u[b]?u[b]+=e:(u[b]=e,k=Math.max(e,k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,
l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,u)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=u));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,z)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,z)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in u)u.hasOwnProperty(q)&&!isNaN(q)&&(a=u[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,k)),q<
c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,k))))}};m.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=!1,u=!1,z=[],k=0;k<a.dataSeriesIndexes.length;k++){var n=this.data[a.dataSeriesIndexes[k]],p=0,q=!1,g=!1,r;if("normal"===n.axisPlacement||"xySwapped"===n.axisPlacement)var h=a.axisX.sessionVariables.newViewportMinimum?
...
b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(u=!0),z[b]=z[b]?z[b]+Math.abs(e):Math.abs(e))}}n.axisX.valueType=n.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&!u?(d.max=s(d.viewPortMax)?99:Math.max(d.viewPortMax,
...
f,l,u=!1,z=0;z<a.dataSeriesIndexes.length;z++){var k=this.data[a.dataSeriesIndexes[z]],n=0,p=!1,q=!1,g,r,h;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var m=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,t=a.axisX.sessionVariables.newViewportMaximum?
...
(c.viewPortMin=g):(f<d.viewPortMin&&(d.viewPortMin=f),l>d.viewPortMax&&(d.viewPortMax=l))}}k.axisX.valueType=k.xValueType=u?"dateTime":"number"}};m.prototype._processSpecificPlotUnit=function(a){if("waterfall"===a.type&&a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var u=this.data[a.dataSeriesIndexes[l]],z=0,k=!1,n=!1,p=b=0;if("normal"===u.axisPlacement||"xySwapped"===u.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?
a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,g=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;
if(u.dataPoints[z].x&&u.dataPoints[z].x.getTime||"dateTime"===u.xValueType)f=!0;for(z=0;z<u.dataPoints.length;z++)"undefined"!==typeof u.dataPoints[z].isCumulativeSum&&!0===u.dataPoints[z].isCumulativeSum?(u.dataPointEOs[z].cumulativeSumYStartValue=0,u.dataPointEOs[z].cumulativeSum=0===z?0:u.dataPointEOs[z-1].cumulativeSum,u.dataPoints[z].y=0===z?0:u.dataPointEOs[z-1].cumulativeSum):"undefined"!==typeof u.dataPoints[z].isIntermediateSum&&!0===u.dataPoints[z].isIntermediateSum?(u.dataPointEOs[z].cumulativeSumYStartValue=
p,u.dataPointEOs[z].cumulativeSum=0===z?0:u.dataPointEOs[z-1].cumulativeSum,u.dataPoints[z].y=0===z?0:b,p=0===z?0:u.dataPointEOs[z-1].cumulativeSum,b=0):(e="number"!==typeof u.dataPoints[z].y?0:u.dataPoints[z].y,u.dataPointEOs[z].cumulativeSumYStartValue=0===z?0:u.dataPointEOs[z-1].cumulativeSum,u.dataPointEOs[z].cumulativeSum=0===z?e:u.dataPointEOs[z-1].cumulativeSum+e,b+=e);for(z=0;z<u.dataPoints.length;z++)if("undefined"===typeof u.dataPoints[z].x&&(u.dataPoints[z].x=z+(a.axisX.logarithmic?1:0)),
u.dataPoints[z].x.getTime?(f=!0,b=u.dataPoints[z].x.getTime()):b=u.dataPoints[z].x,e=u.dataPoints[z].y,b<c.min&&(c.min=b),b>c.max&&(c.max=b),u.dataPointEOs[z].cumulativeSum<d.min&&(d.min=u.dataPointEOs[z].cumulativeSum),u.dataPointEOs[z].cumulativeSum>d.max&&(d.max=u.dataPointEOs[z].cumulativeSum),0<z&&(a.axisX.logarithmic?(p=b/u.dataPoints[z-1].x,1>p&&(p=1/p),c.minDiff>p&&1!==p&&(c.minDiff=p)):(p=b-u.dataPoints[z-1].x,0>p&&(p*=-1),c.minDiff>p&&0!==p&&(c.minDiff=p)),null!==e&&null!==u.dataPoints[z-
1].y&&(a.axisY.logarithmic?(e=u.dataPointEOs[z].cumulativeSum/u.dataPointEOs[z-1].cumulativeSum,1>e&&(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=u.dataPointEOs[z].cumulativeSum-u.dataPointEOs[z-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||k){if(!k&&(k=!0,0<z)){z-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;u.dataPoints[z].label&&(a.axisX.labels[b]=u.dataPoints[z].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<z&&(u.dataPointEOs[z-
1].cumulativeSum<d.viewPortMin&&(d.viewPortMin=u.dataPointEOs[z-1].cumulativeSum),u.dataPointEOs[z-1].cumulativeSum>d.viewPortMax&&(d.viewPortMax=u.dataPointEOs[z-1].cumulativeSum));u.dataPointEOs[z].cumulativeSum<d.viewPortMin&&(d.viewPortMin=u.dataPointEOs[z].cumulativeSum);u.dataPointEOs[z].cumulativeSum>d.viewPortMax&&(d.viewPortMax=u.dataPointEOs[z].cumulativeSum)}u.axisX.valueType=u.xValueType=f?"dateTime":"number"}};m.prototype.calculateAutoBreaks=function(){function a(a,b,c,e){if(e)return c=
...
c)for(var d=a.axisY.dataInfo,f=a.axisX.dataInfo,g,k=f.min,l=f.max,n=d.min,p=d.max,f=f._dataRanges,d=d._dataRanges,q,u=0,z=0;z<a.dataSeriesIndexes.length;z++){var h=e.data[a.dataSeriesIndexes[z]];if(!(4>h.dataPoints.length))for(u=0;u<h.dataPoints.length;u++)if(b&&(q=(l+1-k)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,g=h.dataPoints[u].x.getTime?h.dataPoints[u].x.getTime():h.dataPoints[u].x,q=Math.floor((g-k)/q),g<f[q].min&&(f[q].min=g),g>f[q].max&&(f[q].max=g)),c){var m=
...
b=(this._axes[l].dataInfo.max+1-z)*Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold)||10,10)/100;var k=this._axes[l].dataInfo._dataRanges,n,p,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;n=k;for(u in q)if(q.hasOwnProperty(u)&&!isNaN(u)&&(p=q[u],!s(p))){var g=Math.floor((p-z)/b);p<n[g].min&&(n[g].min=p);p>n[g].max&&(n[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=
this._axes[l].dataInfo.dataPointYNegativeSums;n=k;for(u in q)q.hasOwnProperty(u)&&!isNaN(u)&&(p=-1*q[u],s(p)||(g=Math.floor((p-z)/b),p<n[g].min&&(n[g].min=p),p>n[g].max&&(n[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(u=0;u<k.length-1;u++)if(n=k[u].max,isFinite(n))for(;u<k.length-1;)if(z=k[u+1].min,isFinite(z)){p=z-n;p>b&&f.push({diff:p,start:n,end:z});break}else u++;if(this._axes[l].scaleBreaks.customBreaks)for(u=0;u<this._axes[l].scaleBreaks.customBreaks.length;u++)for(b=
...
"area"!==b[c].dataSeries.type&&"stepArea"!==b[c].dataSeries.type||(a?b[c].distance<=a.distance&&(a=b[c]):a=b[c]);return a};m.prototype.getObjectAtXY=function(a,d,c){var b=null;if(c=this.getDataPointAtXY(a,d,c||!1))b=c.dataSeries.dataPointIds[c.dataPointIndex];else if(v)b=Wa(a,d,this._eventManager.ghostCtx);else for(c=0;c<this.legend.items.length;c++){var e=this.legend.items[c];a>=e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(b=e.id)}return b};m.prototype.getAutoFontSize=jb;m.prototype.resetOverlayedCanvas=
function(){this.overlaidCanvasCtx.clearRect(0,0,this.width,this.height)};m.prototype.clearCanvas=ib;m.prototype.attachEvent=function(a){this._events.push(a)};m.prototype._touchEventHandler=function(a){if(a.changedTouches&&this.interactivityEnabled){var d=[],c=a.changedTouches,b=c?c[0]:a,e=null;switch(a.type){case "touchstart":case "MSPointerDown":d=["mousemove","mousedown"];this._lastTouchData=La(b);this._lastTouchData.time=new Date;break;case "touchmove":case "MSPointerMove":d=["mousemove"];break;
case "touchend":case "MSPointerUp":var f=this._lastTouchData&&this._lastTouchData.time?new Date-this._lastTouchData.time:0,d="touchstart"===this._lastTouchEventType||"MSPointerDown"===this._lastTouchEventType||300>f?["mouseup","click"]:["mouseup"];break;default:return}if(!(c&&1<c.length)){e=La(b);e.time=new Date;try{var l=e.y-this._lastTouchData.y,f=e.time-this._lastTouchData.time;if(1<Math.abs(l)&&this._lastTouchData.scroll||5<Math.abs(l)&&250>f)this._lastTouchData.scroll=!0}catch(u){}this._lastTouchEventType=
...
(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),l&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(Ia(this._zoomButton,this._resetButton),ta(this,this._zoomButton,"pan"),ta(this,this._resetButton,"reset")))}}this.isDrag=!1;if("none"!==this.plotInfo.axisPlacement){this.resetOverlayedCanvas();if(this.axisX&&0<this.axisX.length)for(l=0;l<this.axisX.length;l++)this.axisX[l].crosshair&&
...
this.zoomType).isValid&&(this.resetOverlayedCanvas(),this.overlaidCanvasCtx.fillStyle="#99B2B5");this.overlaidCanvasCtx.globalAlpha=0.7;this.overlaidCanvasCtx.fillRect(b,u,z,k);this.overlaidCanvasCtx.globalAlpha=c}}else if(this.toolTip.mouseMoveHandler(a,d),"none"!==this.plotInfo.axisPlacement){if(this.axisX&&0<this.axisX.length)for(e=0;e<this.axisX.length;e++)this.axisX[e].crosshair&&this.axisX[e].crosshair.enabled&&this.axisX[e].renderCrosshair(a,d);if(this.axisX2&&0<this.axisX2.length)for(e=0;e<
...
l=0<=this.zoomType.indexOf("y"),u=!1,z=[],k=[],n=[],p=0;p<this._axes.length;p++)("axisX"===this._axes[p].type&&f||"axisY"===this._axes[p].type&&l)&&k.push(this._axes[p]);for(l=0;l<k.length;l++){var p=k[l],f=!1,q=p.convertPixelToValue({x:a,y:d}),g=p.convertPixelToValue({x:c,y:b});if(q>g)var r=g,g=q,q=r;if(p.scaleBreaks)for(r=0;!f&&r<p.scaleBreaks._appliedBreaks.length;r++)f=p.scaleBreaks._appliedBreaks[r].startValue<=q&&p.scaleBreaks._appliedBreaks[r].endValue>=g;if(isFinite(p.dataInfo.minDiff))if(r=
p.getApparentDifference(q,g,null,!0),!(f||!(this.panEnabled&&p.scaleBreaks&&p.scaleBreaks._appliedBreaks.length)&&(p.logarithmic&&r<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&r<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||g>p.maximum))z.push(p),n.push({val1:q,val2:g}),u=!0;else if(!e){u=!1;break}}return{isValid:u,axesWithValidRange:z,axesRanges:n}};m.prototype.preparePlotArea=function(){var a=this.plotArea;!v&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&
...
new Ba(a.x1,a.y1,a.x2,a.y2,2)};m.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,l=f=e=0,u=0,z=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=ka("indexLabelFontColor",n.dataPoint,n.dataSeries),r=ka("indexLabelFontSize",n.dataPoint,n.dataSeries),u=ka("indexLabelFontFamily",n.dataPoint,n.dataSeries),z=ka("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=ka("indexLabelFontWeight",n.dataPoint,
...
this.plotArea.height:this.plotArea.width)<<0):0,A={percent:null,total:null},C=null;if(0<=n.dataSeries.type.indexOf("stacked")||"pie"===n.dataSeries.type||"doughnut"===n.dataSeries.type)A=this.getPercentAndTotal(n.dataSeries,n.dataPoint);if(n.dataSeries.indexLabelFormatter||n.dataPoint.indexLabelFormatter)C={chart:this,dataSeries:n.dataSeries,dataPoint:n.dataPoint,index:n.indexKeyword,total:A.total,percent:A.percent};var D=n.dataPoint.indexLabelFormatter?n.dataPoint.indexLabelFormatter(C):n.dataPoint.indexLabel?
this.replaceKeywordsWithValue(n.dataPoint.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):n.dataSeries.indexLabelFormatter?n.dataSeries.indexLabelFormatter(C):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==D&&""!==D){var A=ka("indexLabelPlacement",n.dataPoint,n.dataSeries),C=ka("indexLabelOrientation",n.dataPoint,n.dataSeries),B=n.direction,e=n.dataSeries.axisX,f=n.dataSeries.axisY,w=!1,h=new ia(d,
{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*r:1.5*r,angle:"horizontal"===C?0:-90,text:D,padding:0,backgroundColor:h,horizontalAlign:"left",fontSize:r,fontFamily:u,fontWeight:k,fontColor:l,fontStyle:z,textBaseline:"middle"});h.measureText();n.dataSeries.indexLabelMaxWidth=h.maxWidth;if("stackedarea100"===p){if(n.point.x<c.x1||n.point.x>c.x2||n.point.y<c.y1-1||n.point.y>c.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||
...
l=u=2;"horizontal"===C?(z=h.width,k=h.height):(k=h.width,z=h.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))A="auto",u=4;else if(0<=p.indexOf("stacked"))"auto"===A&&(A="inside");else if("bubble"===p||"scatter"===p)A="inside";q=n.point.x-("horizontal"===C?z/2:z/2-r/2);"inside"!==A?(e=c.y1,f=c.y2,0<B?(g=n.point.y+("horizontal"===C?r/2:0)-k-u-b,g<e&&(g="auto"===A?Math.max(n.point.y,e)+r/2+u:e+r/2+u,w=g+k>n.point.y)):(g=n.point.y+r/2+u+b,g>f-k&&(g="auto"===
A?Math.min(n.point.y,f)+r/2-k-u:f+r/2-k,w=g<n.point.y))):(e=Math.max(n.bounds.y1,c.y1),f=Math.min(n.bounds.y2,c.y2-k+r/2),b=0<=p.indexOf("range")||"error"===p?0<B?Math.max(n.bounds.y1,c.y1)+r/2+u:Math.min(n.bounds.y2,c.y2)+r/2-k+u:(Math.max(n.bounds.y1,c.y1)+Math.min(n.bounds.y2,c.y2))/2-k/2+r/2+("horizontal"===C?u:0),0<B?(g=Math.max(n.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(n.point.y-k-u,c.y1+u))):(g=Math.min(n.point.y,b),g>f-k-u&&("bubble"===p||"scatter"===p)&&(g=Math.min(n.point.y+
u,c.y2-k-u))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("scatter")?(A="auto",l=4):0<=p.indexOf("stacked")?"auto"===A&&(A="inside"):"bubble"===p&&(A="inside"),g=n.point.y+r/2-k/2+u,"inside"!==A?(e=c.x1,f=c.x2,0>B?(q=n.point.x-("horizontal"===C?z:z-r/2)-l-b,q<e&&(q="auto"===A?Math.max(n.point.x,e)+l:e+l,w=q+z>n.point.x)):(q=n.point.x+("horizontal"===C?0:r/2)+l+b,q>f-z-l-b&&(q="auto"===A?Math.min(n.point.x,f)-("horizontal"===C?z:z/2)-l:f-z-l,w=q<n.point.x))):(e=Math.max(n.bounds.x1,
c.x1),Math.min(n.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===p?0>B?Math.max(n.bounds.x1,c.x1)+r/2+l:Math.min(n.bounds.x2,c.x2)-z/2-l+("horizontal"===C?0:r/2):(Math.max(n.bounds.x1,c.x1)+Math.min(n.bounds.x2,c.x2))/2+("horizontal"===C?0:r/2),q=0>B?Math.max(n.point.x,b)-("horizontal"===C?z/2:0):Math.min(n.point.x,b)-z/2,q=Math.max(q,e));"vertical"===C&&(g+=k-r/2);h.x=q;h.y=g;h.render(!0);x&&("inside"!==A&&(0>p.indexOf("bar")&&("error"!==p||!n.axisSwapped)&&n.point.x>c.x1&&n.point.x<c.x2||!w)&&
(0>p.indexOf("column")&&("error"!==p||n.axisSwapped)&&n.point.y>c.y1&&n.point.y<c.y2||!w))&&(d.lineWidth=x,d.strokeStyle=t?t:"gray",d.setLineDash&&d.setLineDash(O(m,x)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:z+l)+("vertical"===C?-r/2:0),g+("vertical"===C?-k/2:k/2-r/2)-u):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+z/2-("horizontal"===C?0:r/2),g+("vertical"===C?(g-k<n.point.y?0:-k)+u:(g-r/2<n.point.y?
k:0)-r/2)):d.lineTo(q+z/2-("horizontal"===C?0:r/2),g+("vertical"===C?g-k<n.point.y?0:-k:(g-r/2<n.point.y?k:0)-r/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)n=this._indexLabels[a],h=ka("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),n.dataSeries.indexLabelBackgroundColor=s(h)?v?"transparent":null:h;return d};m.prototype.renderLine=function(a){var d=
a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,u=0;u<a.dataSeriesIndexes.length;u++){var z=a.dataSeriesIndexes[u],k=this.data[z];c.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(c.setLineDash){var q=O(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=O(p,k.lineThickness);c.setLineDash(g)}var r=
k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:z};r=Q(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,t=0,x,s;c.beginPath();if(0<n.length){for(var C=!1,t=0;t<n.length;t++)if(x=n[t].x.getTime?n[t].x.getTime():n[t].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!C)))if("number"!==typeof n[t].y)0<
t&&!(k.connectNullData||C||m)&&(c.stroke(),v&&b.stroke()),C=!0;else{x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(n[t].y);var D=k.dataPointIds[t];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:t,x1:x,y1:s};m||C?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,
s),v&&b.lineTo(x,s)):(c.beginPath(),c.moveTo(x,s),v&&(b.beginPath(),b.moveTo(x,s))),C=m=!1):(c.lineTo(x,s),v&&b.lineTo(x,s),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),v&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};t<n.length-1&&(h!==(n[t].lineColor||r)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,s),h=n[t].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(O(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));
if(0<n[t].markerSize||0<k.markerSize){var B=k.getMarkerProperties(t,x,s,c);f.push(B);D=Q(D);v&&f.push({x:x,y:s,ctx:b,type:B.type,size:B.size,color:D,borderColor:D,borderThickness:B.borderThickness})}(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[t],dataSeries:k,point:{x:x,y:s},direction:0>n[t].y===a.axisY.reversed?1:-1,color:r})}c.stroke();v&&b.stroke()}}W.drawMarkers(f);v&&(d.drawImage(this._preRenderCanvas,0,
...
p=k.lineDashType,g=O(p,k.lineThickness);c.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:z};r=Q(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,t=0,x,s;c.beginPath();if(0<n.length){for(var C=!1,t=0;t<n.length;t++)if(x=n[t].getTime?n[t].x.getTime():n[t].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&
(!k.connectNullData||!C)))if("number"!==typeof n[t].y)0<t&&!(k.connectNullData||C||m)&&(c.stroke(),v&&b.stroke()),C=!0;else{var D=s;x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(n[t].y);var B=k.dataPointIds[t];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:t,x1:x,y1:s};m||C?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,
l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,D),c.lineTo(x,s),v&&(b.lineTo(x,D),b.lineTo(x,s))):(c.beginPath(),c.moveTo(x,s),v&&(b.beginPath(),b.moveTo(x,s))),C=m=!1):(c.lineTo(x,D),v&&b.lineTo(x,D),c.lineTo(x,s),v&&b.lineTo(x,s),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),v&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};t<n.length-1&&(h!==(n[t].lineColor||r)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,s),h=n[t].lineColor||r,c.strokeStyle=
h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(O(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<k.markerSize)D=k.getMarkerProperties(t,x,s,c),f.push(D),B=Q(B),v&&f.push({x:x,y:s,ctx:b,type:D.type,size:D.size,color:B,borderColor:B,borderThickness:D.borderThickness});(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[t],dataSeries:k,point:{x:x,y:s},direction:0>
...
this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],u=0;u<a.dataSeriesIndexes.length;u++){var z=a.dataSeriesIndexes[u],k=this.data[z];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=O(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=O(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:z};r=Q(r);e.strokeStyle=r;e.lineWidth=
...
1].newLineDashArray=q,p=k.nullDataLineDashType):(d(s),s=[])),x=!0;else{t=a.axisX.convertValueToPixel(t);x=a.axisY.convertValueToPixel(n[m].y);var C=k.dataPointIds[m];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:m,x1:t,y1:x};s[s.length]={x:t,y:x};m<n.length-1&&(h!==(n[m].lineColor||r)||p!==(n[m].lineDashType||k.lineDashType))&&(h=n[m].lineColor||r,s[s.length-1].newStrokeStyle=h,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,s[s.length-1].newLineDashArray=
O(p,k.lineThickness)):(p=k.lineDashType,s[s.length-1].newLineDashArray=g)));if(0<n[m].markerSize||0<k.markerSize){var D=k.getMarkerProperties(m,t,x,b);l.push(D);C=Q(C);v&&l.push({x:t,y:x,ctx:e,type:D.type,size:D.size,color:C,borderColor:C,borderThickness:D.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:t,y:x},direction:0>n[m].y===a.axisY.reversed?1:-1,color:r});x=!1}d(s)}W.drawMarkers(l);
...
0;f<r.length;f++)if(r[f].getTime?z=r[f].x.getTime():z=r[f].x,!(z<a.axisX.dataInfo.viewPortMin||z>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(z);u=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,t;0<=r[f].y?t=k:(t=u,u=k);u>t&&(b=u,u=t,t=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];
...
a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length){var x=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);var s=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=s+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)u[b]=t[k].y+(u[b]?u[b]:
0),0<u[b]&&(p=a.axisY.convertValueToPixel(u[b]),D="undefined"!==typeof f[b]?f[b]:q,f[b]=p);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)z[b]=t[k].y+(z[b]?z[b]:0),D=a.axisY.convertValueToPixel(z[b]),p="undefined"!==typeof l[b]?l[b]:q,l[b]=D;else if(p=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var B="undefined"!==typeof f[b]?f[b]:0;p-=B;D=q-B;f[b]=B+(D-p)}else B=l[b]?l[b]:0,D=p+B,p=q+B,l[b]=B+(D-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];
ca(c,s,p,C,D,b,0,null,x&&0<=t[k].y,0>t[k].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:s,y1:p,x2:C,y2:D};b=Q(b);v&&ca(this._eventManager.ghostCtx,s,p,C,D,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:t[k],dataSeries:m,point:{x:n,y:0<=t[k].y?p:D},direction:0>t[k].y===a.axisY.reversed?
1:-1,bounds:{x1:s,y1:Math.min(p,D),x2:C,y2:Math.max(p,D)},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.yScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],u=[],z=[],k=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&
k>n&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<k)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));g<k&&(g=k);g>n&&(g=n);c.save();v&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();v&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=
a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length)for(var x=5<g&&m.bevelEnabled?!0:!1,k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;var s=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=s+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0<t[k].y){u[b]=p+("undefined"!==typeof u[b]?u[b]:0);if(0>=u[b])continue;p=a.axisY.convertValueToPixel(u[b]);D=f[b]?f[b]:q;f[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)z[b]=p+("undefined"!==typeof z[b]?z[b]:0),D=a.axisY.convertValueToPixel(z[b]),p=l[b]?l[b]:q,l[b]=D;else if(p=a.axisY.convertValueToPixel(p),0<=t[k].y){var B="undefined"!==typeof f[b]?f[b]:0;p-=B;D=q-B;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=B+(D-p)}else B="undefined"!==
typeof l[b]?l[b]:0,D=p+B,p=q+B,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y2-D)&&(D=e.y2),l[b]=B+(D-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,s,p,C,D,b,0,null,x&&0<=t[k].y,0>t[k].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:s,y1:p,x2:C,y2:D};b=Q(b);v&&ca(this._eventManager.ghostCtx,s,p,C,D,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&
this._indexLabels.push({chartType:"stackedColumn100",dataPoint:t[k],dataSeries:m,point:{x:n,y:0<=t[k].y?p:D},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(p,D),x2:C,y2:Math.max(p,D)},color:b})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
...
t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);var s=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=s+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)u[b]=t[k].y+(u[b]?u[b]:0),0<u[b]&&(D=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(u[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)z[b]=t[k].y+(z[b]?z[b]:0),n=l[b]?
l[b]:q,l[b]=D=a.axisY.convertValueToPixel(z[b]);else if(n=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var B=f[b]?f[b]:0;D=q+B;n+=B;f[b]=B+(n-D)}else B=l[b]?l[b]:0,D=n-B,n=q-B,l[b]=B+(n-D);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,D,s,n,C,b,0,null,x,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:D,y1:s,x2:n,y2:C};b=Q(b);v&&ca(this._eventManager.ghostCtx,D,s,n,C,b,0,null,!1,!1,!1,
!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:D,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(D,n),y1:s,x2:Math.max(D,n),y2:C},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);var s;s=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;var C=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,D=C+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y){u[b]=s+(u[b]?u[b]:0);if(0>=u[b])continue;s=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(u[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)z[b]=s+(z[b]?z[b]:0),n=l[b]?l[b]:
q,l[b]=s=a.axisY.convertValueToPixel(z[b]);else if(n=a.axisY.convertValueToPixel(s),0<=t[k].y){var B=f[b]?f[b]:0;s=q+B;n+=B;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=B+(n-s)}else B=l[b]?l[b]:0,s=n-B,n=q-B,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-s)&&(s=e.x1),l[b]=B+(n-s);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,s,C,n,D,b,0,null,x,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,
dataPointIndex:k,x1:s,y1:C,x2:n,y2:D};b=Q(b);v&&ca(this._eventManager.ghostCtx,s,C,n,D,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:s,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(s,n),y1:C,x2:Math.max(s,n),y2:D},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=A:0>a.axisY.viewportMaximum?C=u.y1:0<a.axisY.viewportMinimum&&(C=A),f.lineTo(m,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,v&&(l.lineTo(m,C),l.lineTo(D.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),D={x:m,y:t})}
var e=a.targetCanvasCtx||this.plotArea.ctx,f=v?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,u=a.axisY.lineCoordinates,z=[],k=this.plotArea,n;f.save();v&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();v&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,z=g.id;this._eventManager.objectMap[z]={objectType:"dataSeries",dataSeriesIndex:q};
z=Q(z);l.fillStyle=z;z=[];d=!0;var h=0,m,t,s,A=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),C,D=null;if(0<r.length){var B=g._colorSet[h%g._colorSet.length],w=g.lineColor=g.options.lineColor||B,y=w;f.fillStyle=B;f.strokeStyle=w;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var K=O(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var aa=O(c,g.lineThickness);f.setLineDash(aa)}for(var ja=!0;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<
a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ja)))if("number"!==typeof r[h].y)g.connectNullData||(ja||d)||b(),ja=!0;else{m=a.axisX.convertValueToPixel(s);t=a.axisY.convertValueToPixel(r[h].y);d||ja?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),f.moveTo(n.x,n.y),m=d,t=c,D=n,c=g.nullDataLineDashType,f.setLineDash(K)),f.lineTo(m,t),v&&l.lineTo(m,t)):
(f.beginPath(),f.moveTo(m,t),v&&(l.beginPath(),l.moveTo(m,t)),D={x:m,y:t}),ja=d=!1):(f.lineTo(m,t),v&&l.lineTo(m,t),0==h%250&&b());n={x:m,y:t};h<r.length-1&&(y!==(r[h].lineColor||w)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),y=r[h].lineColor||w,f.strokeStyle=y,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(O(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(aa))));var Y=g.dataPointIds[h];this._eventManager.objectMap[Y]={id:Y,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,
x1:m,y1:t};0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,m,t,f),z.push(s),Y=Q(Y),v&&z.push({x:m,y:t,ctx:l,type:s.type,size:s.size,color:Y,borderColor:Y,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:m,y:t},direction:0>r[h].y===a.axisY.reversed?1:-1,color:B})}b();W.drawMarkers(z)}}v&&(e.drawImage(this._preRenderCanvas,
...
u.y1,u.width,u.height);b.clip();v&&(e.beginPath(),e.rect(u.x1,u.y1,u.width,u.height),e.clip());for(var z=0;z<a.dataSeriesIndexes.length;z++){var k=a.dataSeriesIndexes[z],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=Q(l);e.fillStyle=l;var l=[],q=0,g,r,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,t=null,s=[];if(0<p.length){var A=n._colorSet[q%n._colorSet.length],C=n.lineColor=n.options.lineColor||
A,D=C;b.fillStyle=A;b.strokeStyle=C;b.lineWidth=n.lineThickness;var B="solid";if(b.setLineDash){var y=O(n.nullDataLineDashType,n.lineThickness),B=n.lineDashType,E=O(B,n.lineThickness);b.setLineDash(E)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(n.connectNullData?b.setLineDash&&(0<s.length&&(n.options.nullDataLineDashType||!p[q-1].lineDashType))&&
(s[s.length-1].newLineDashArray=y,B=n.nullDataLineDashType):(d(),s=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);var K=n.dataPointIds[q];this._eventManager.objectMap[K]={id:K,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};s[s.length]={x:g,y:r};q<p.length-1&&(D!==(p[q].lineColor||C)||B!==(p[q].lineDashType||n.lineDashType))&&(D=p[q].lineColor||C,s[s.length-1].newStrokeStyle=D,b.setLineDash&&(p[q].lineDashType?(B=p[q].lineDashType,s[s.length-
1].newLineDashArray=O(B,n.lineThickness)):(B=n.lineDashType,s[s.length-1].newLineDashArray=E)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(q,g,r,b);l.push(aa);K=Q(K);v&&l.push({x:g,y:r,ctx:e,type:aa.type,size:aa.size,color:K,borderColor:K,borderThickness:aa.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:r},direction:0>
p[q].y===a.axisY.reversed?1:-1,color:A});r=!1}d();W.drawMarkers(l)}}v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(u.x1,u.y1,u.width,u.height),this._eventManager.ghostCtx.restore());
b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=A:0>a.axisY.viewportMaximum?C=u.y1:0<a.axisY.viewportMinimum&&(C=A),f.lineTo(m,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,v&&(l.lineTo(m,C),l.lineTo(D.x,
C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),D={x:m,y:t})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=v?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,u=a.axisY.lineCoordinates,z=[],k=this.plotArea,n;f.save();v&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();v&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],
g=this.data[q],r=g.dataPoints,z=g.id;this._eventManager.objectMap[z]={objectType:"dataSeries",dataSeriesIndex:q};z=Q(z);l.fillStyle=z;z=[];d=!0;var h=0,m,t,s,A=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),C,D=null;c=!1;if(0<r.length){var B=g._colorSet[h%g._colorSet.length],w=g.lineColor=g.options.lineColor||B,y=w;f.fillStyle=B;f.strokeStyle=w;f.lineWidth=g.lineThickness;var K="solid";if(f.setLineDash){var aa=O(g.nullDataLineDashType,g.lineThickness),K=g.lineDashType,
E=O(K,g.lineThickness);f.setLineDash(E)}for(;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var Y=t;"number"!==typeof r[h].y?(g.connectNullData||(c||d)||b(),c=!0):(m=a.axisX.convertValueToPixel(s),t=a.axisY.convertValueToPixel(r[h].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||K===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),
f.moveTo(n.x,n.y),m=d,t=c,D=n,K=g.nullDataLineDashType,f.setLineDash(aa)),f.lineTo(m,Y),f.lineTo(m,t),v&&(l.lineTo(m,Y),l.lineTo(m,t))):(f.beginPath(),f.moveTo(m,t),v&&(l.beginPath(),l.moveTo(m,t)),D={x:m,y:t}),c=d=!1):(f.lineTo(m,Y),v&&l.lineTo(m,Y),f.lineTo(m,t),v&&l.lineTo(m,t),0==h%250&&b()),n={x:m,y:t},h<r.length-1&&(y!==(r[h].lineColor||w)||K!==(r[h].lineDashType||g.lineDashType))&&(b(),y=r[h].lineColor||w,f.strokeStyle=y,f.setLineDash&&(r[h].lineDashType?(K=r[h].lineDashType,f.setLineDash(O(K,
g.lineThickness))):(K=g.lineDashType,f.setLineDash(E)))),s=g.dataPointIds[h],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:t},0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(Y=g.getMarkerProperties(h,m,t,f),z.push(Y),s=Q(s),v&&z.push({x:m,y:t,ctx:l,type:Y.type,size:Y.size,color:s,borderColor:s,borderThickness:Y.borderThickness})),(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",
...
a.targetCanvasCtx||this.plotArea.ctx,b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],u=this.plotArea,h=[],k=[],n=[],p=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s=this._eventManager.ghostCtx,t,x,A;v&&s.beginPath();b.save();v&&s.save();b.beginPath();b.rect(u.x1,u.y1,u.width,u.height);b.clip();v&&(s.beginPath(),s.rect(u.x1,u.y1,u.width,u.height),s.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var D=a.dataSeriesIndexes[C],
B=this.data[D],w=B.dataPoints;B.dataPointIndexes=[];for(q=0;q<w.length;q++)D=w[q].x.getTime?w[q].x.getTime():w[q].x,B.dataPointIndexes[D]=q,e[D]||(n.push(D),e[D]=!0);n.sort(Na)}for(C=0;C<a.dataSeriesIndexes.length;C++){D=a.dataSeriesIndexes[C];B=this.data[D];w=B.dataPoints;x=!0;k=[];q=B.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:D};q=Q(q);s.fillStyle=q;if(0<n.length){var e=B._colorSet[0],y=B.lineColor=B.options.lineColor||e,K=y;b.fillStyle=e;b.strokeStyle=y;b.lineWidth=
B.lineThickness;A="solid";if(b.setLineDash){var aa=O(B.nullDataLineDashType,B.lineThickness);A=B.lineDashType;var E=O(A,B.lineThickness);b.setLineDash(E)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],fa=null,fa=0<=B.dataPointIndexes[f]?w[B.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!Y)))if("number"!==typeof fa.y)B.connectNullData||(Y||x)||d(),Y=!0;else{g=a.axisX.convertValueToPixel(f);var la=h[f]?h[f]:0;if(a.axisY.logarithmic||
a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=fa.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(fa.y),r-=la;k.push({x:g,y:m-la});h[f]=m-r;x||Y?(!x&&B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||A===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(x=k.pop(),A=k[k.length-1],d(),b.moveTo(t.x,t.y),k.push(A),k.push(x),A=B.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,
r),v&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),v&&(s.beginPath(),s.moveTo(g,r))),Y=x=!1):(b.lineTo(g,r),v&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),v&&s.moveTo(g,r),k.push({x:g,y:m-la})));t={x:g,y:r};q<w.length-1&&(K!==(w[q].lineColor||y)||A!==(w[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:m-la}),K=w[q].lineColor||y,b.strokeStyle=K,b.setLineDash&&(w[q].lineDashType?(A=w[q].lineDashType,b.setLineDash(O(A,B.lineThickness))):(A=B.lineDashType,b.setLineDash(E))));
if(0<=B.dataPointIndexes[f]){var F=B.dataPointIds[B.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:r}}0<=B.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<B.markerSize)&&(la=B.getMarkerProperties(B.dataPointIndexes[f],g,r,b),l.push(la),f=Q(F),v&&l.push({x:g,y:r,ctx:s,type:la.type,size:la.size,color:f,borderColor:f,borderThickness:la.borderThickness}));(fa.indexLabel||B.indexLabel||fa.indexLabelFormatter||
...
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(u.x1,u.y1,u.width,u.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<B.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);v&&A.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();
b.globalAlpha=1;b.beginPath();v&&(A.closePath(),A.fill(),A.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,u=[],h=[],k=[],n=[],p=[],q=0,g,r,m,s,t,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),A=this._eventManager.ghostCtx;b.save();v&&A.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();v&&(A.beginPath(),A.rect(l.x1,l.y1,l.width,l.height),A.clip());
for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var w=a.dataSeriesIndexes[C],B=this.data[w],y=B.dataPoints;B.dataPointIndexes=[];for(q=0;q<y.length;q++)w=y[q].x.getTime?y[q].x.getTime():y[q].x,B.dataPointIndexes[w]=q,e[w]||(n.push(w),e[w]=!0);n.sort(Na)}for(C=0;C<a.dataSeriesIndexes.length;C++){w=a.dataSeriesIndexes[C];B=this.data[w];y=B.dataPoints;s=!0;e=B.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:w};e=Q(e);A.fillStyle=e;k=[];if(0<n.length){var e=B._colorSet[q%
B._colorSet.length],E=B.lineColor=B.options.lineColor||e,K=E;b.fillStyle=e;b.strokeStyle=E;b.lineWidth=B.lineThickness;t="solid";if(b.setLineDash){var aa=O(B.nullDataLineDashType,B.lineThickness);t=B.lineDashType;var F=O(t,B.lineThickness);b.setLineDash(F)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],fa=null,fa=0<=B.dataPointIndexes[f]?y[B.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!Y)))if("number"!==typeof fa.y)B.connectNullData||
(Y||s)||d(),Y=!0;else{var la;la=0!==a.dataPointYSums[f]?100*(fa.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var ba=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=la+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(la),r-=ba;k.push({x:g,y:x-ba});h[f]=x-r;s||Y?(!s&&B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||t===B.lineDashType&&
B.lineDashType!==B.nullDataLineDashType)&&(s=k.pop(),t=k[k.length-1],d(),b.moveTo(m.x,m.y),k.push(t),k.push(s),t=B.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),v&&A.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),v&&(A.beginPath(),A.moveTo(g,r))),Y=s=!1):(b.lineTo(g,r),v&&A.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),v&&A.moveTo(g,r),k.push({x:g,y:x-ba})));m={x:g,y:r};q<y.length-1&&(K!==(y[q].lineColor||E)||t!==(y[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:x-
ba}),K=y[q].lineColor||E,b.strokeStyle=K,b.setLineDash&&(y[q].lineDashType?(t=y[q].lineDashType,b.setLineDash(O(t,B.lineThickness))):(t=B.lineDashType,b.setLineDash(F))));if(0<=B.dataPointIndexes[f]){var G=B.dataPointIds[B.dataPointIndexes[f]];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:r}}0<=B.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<B.markerSize)&&(ba=B.getMarkerProperties(q,g,r,b),u.push(ba),f=Q(G),
v&&u.push({x:g,y:r,ctx:A,type:ba.type,size:ba.size,color:f,borderColor:f,borderThickness:ba.borderThickness}));(fa.indexLabel||B.indexLabel||fa.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:fa,dataSeries:B,point:{x:g,y:r},direction:0>y[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);v&&A.moveTo(g,r)}delete B.dataPointIndexes}W.drawMarkers(u);v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),A.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderBubble=function(a){var d=
...
e&&(r=e);r>f&&(r=f);c.save();v&&b.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();v&&(b.beginPath(),b.rect(l.x1,l.y1,l.width,l.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var w=a.dataSeriesIndexes[m],t=this.data[w],x=t.dataPoints;if(0<x.length)for(var A=5<r&&t.bevelEnabled?!0:!1,u=0;u<x.length;u++)if(x[u].getTime?g=x[u].x.getTime():g=x[u].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(x[u].y)&&x[u].y.length&&"number"===typeof x[u].y[0]&&
"number"===typeof x[u].y[1]&&"number"===typeof x[u].y[2]&&"number"===typeof x[u].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(x[u].y[0]);n=a.axisY.convertValueToPixel(x[u].y[1]);p=a.axisY.convertValueToPixel(x[u].y[2]);q=a.axisY.convertValueToPixel(x[u].y[3]);var C=h-r/2<<0,D=C+r<<0,f=t.options.fallingColor?t.fallingColor:t._colorSet[0],e=x[u].color?x[u].color:t._colorSet[0],B=Math.round(Math.max(1,0.15*r)),y=0===B%2?0:0.5,E=t.dataPointIds[u];this._eventManager.objectMap[E]=
{id:E,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:u,x1:C,y1:k,x2:D,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:B,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=B;b.lineWidth=Math.max(B,4);"candlestick"===t.type?(c.moveTo(h-y,n),c.lineTo(h-y,Math.min(k,q)),c.stroke(),c.moveTo(h-y,Math.max(k,q)),c.lineTo(h-y,p),c.stroke(),ca(c,C,Math.min(k,q),D,Math.max(k,q),x[u].y[0]<=x[u].y[3]?t.risingColor:f,B,e,A,A,!1,!1,t.fillOpacity),v&&(e=Q(E),b.strokeStyle=e,b.moveTo(h-y,n),b.lineTo(h-y,Math.min(k,
q)),b.stroke(),b.moveTo(h-y,Math.max(k,q)),b.lineTo(h-y,p),b.stroke(),ca(b,C,Math.min(k,q),D,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===t.type&&(c.moveTo(h-y,n),c.lineTo(h-y,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(C,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(D,q),c.stroke(),v&&(e=Q(E),b.strokeStyle=e,b.moveTo(h-y,n),b.lineTo(h-y,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(C,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(D,q),b.stroke()));(x[u].indexLabel||t.indexLabel||
x[u].indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:t.type,dataPoint:x[u],dataSeries:t,point:{x:C+(D-C)/2,y:a.axisY.reversed?p:n},direction:1,bounds:{x1:C,y1:Math.min(n,p),x2:D,y2:Math.max(n,p)},color:e})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
...
l&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<e)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));r<e&&(r=e);r>l&&(r=l);c.save();v&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();v&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,w=0;w<a.dataSeriesIndexes.length;w++){var t=a.dataSeriesIndexes[w],x=this.data[t],A=x.dataPoints;
if(0<A.length)for(var C=5<r&&x.bevelEnabled?!0:!1,l=0;l<A.length;l++)if(A[l].getTime?g=A[l].x.getTime():g=A[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(A[l].y)&&A[l].y.length&&"number"===typeof A[l].y[0]&&"number"===typeof A[l].y[1]&&"number"===typeof A[l].y[2]&&"number"===typeof A[l].y[3]&&"number"===typeof A[l].y[4]&&5===A[l].y.length){u=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(A[l].y[0]);k=a.axisY.convertValueToPixel(A[l].y[1]);n=a.axisY.convertValueToPixel(A[l].y[2]);
p=a.axisY.convertValueToPixel(A[l].y[3]);q=a.axisY.convertValueToPixel(A[l].y[4]);var D=u-r/2<<0,B=u+r/2<<0,e=A[l].color?A[l].color:x._colorSet[0],y=Math.round(Math.max(1,0.15*r)),E=0===y%2?0:0.5,K=A[l].whiskerColor?A[l].whiskerColor:A[l].color?x.whiskerColor?x.whiskerColor:A[l].color:x.whiskerColor?x.whiskerColor:e,aa="number"===typeof A[l].whiskerThickness?A[l].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:y,F=A[l].whiskerDashType?A[l].whiskerDashType:x.whiskerDashType,
Y=s(A[l].whiskerLength)?s(x.options.whiskerLength)?r:x.whiskerLength:A[l].whiskerLength,Y="number"===typeof Y?0>=Y?0:Y>=r?r:Y:"string"===typeof Y?parseInt(Y)*r/100>r?r:parseInt(Y)*r/100:r,fa=1===Math.round(aa)%2?0.5:0,la=A[l].stemColor?A[l].stemColor:A[l].color?x.stemColor?x.stemColor:A[l].color:x.stemColor?x.stemColor:e,ba="number"===typeof A[l].stemThickness?A[l].stemThickness:"number"===typeof x.options.stemThickness?x.stemThickness:y,G=1===Math.round(ba)%2?0.5:0,J=A[l].stemDashType?A[l].stemDashType:
x.stemDashType,H=A[l].lineColor?A[l].lineColor:A[l].color?x.lineColor?x.lineColor:A[l].color:x.lineColor?x.lineColor:e,N="number"===typeof A[l].lineThickness?A[l].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:y,R=A[l].lineDashType?A[l].lineDashType:x.lineDashType,M=1===Math.round(N)%2?0.5:0,U=x.upperBoxColor,va=x.lowerBoxColor,qa=s(x.options.fillOpacity)?1:x.fillOpacity,P=x.dataPointIds[l];this._eventManager.objectMap[P]={id:P,objectType:"dataPoint",dataSeriesIndex:t,dataPointIndex:l,
x1:D,y1:h,x2:B,y2:k,x3:u,y3:n,x4:u,y4:p,y5:q,borderThickness:y,color:e,stemThickness:ba,stemColor:la,whiskerThickness:aa,whiskerLength:Y,whiskerColor:K,lineThickness:N,lineColor:H};c.save();0<ba&&(c.beginPath(),c.strokeStyle=la,c.lineWidth=ba,c.setLineDash&&c.setLineDash(O(J,ba)),c.moveTo(u-G,k),c.lineTo(u-G,h),c.stroke(),c.moveTo(u-G,p),c.lineTo(u-G,n),c.stroke());c.restore();b.lineWidth=Math.max(y,4);c.beginPath();ca(c,D,Math.min(q,k),B,Math.max(k,q),va,0,e,m?C:!1,m?!1:C,!1,!1,qa);c.beginPath();
ca(c,D,Math.min(n,q),B,Math.max(q,n),U,0,e,m?!1:C,m?C:!1,!1,!1,qa);c.beginPath();c.lineWidth=y;c.strokeStyle=e;c.rect(D-E,Math.min(k,n)-E,B-D+2*E,Math.max(k,n)-Math.min(k,n)+2*E);c.stroke();c.save();0<N&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(O(R,N)),c.strokeStyle=H,c.lineWidth=N,c.moveTo(D,q-M),c.lineTo(B,q-M),c.stroke());c.restore();c.save();0<aa&&(c.beginPath(),c.setLineDash&&c.setLineDash(O(F,aa)),c.strokeStyle=K,c.lineWidth=aa,c.moveTo(u-Y/2<<0,p-fa),c.lineTo(u+Y/2<<0,p-
fa),c.stroke(),c.moveTo(u-Y/2<<0,h+fa),c.lineTo(u+Y/2<<0,h+fa),c.stroke());c.restore();v&&(e=Q(P),b.strokeStyle=e,b.lineWidth=ba,0<ba&&(b.moveTo(u-E-G,k),b.lineTo(u-E-G,Math.max(h,p)),b.stroke(),b.moveTo(u-E-G,Math.min(h,p)),b.lineTo(u-E-G,n),b.stroke()),ca(b,D,Math.max(k,n),B,Math.min(k,n),e,0,null,!1,!1,!1,!1),0<aa&&(b.beginPath(),b.lineWidth=aa,b.moveTo(u+Y/2,p-fa),b.lineTo(u-Y/2,p-fa),b.stroke(),b.moveTo(u+Y/2,h+fa),b.lineTo(u-Y/2,h+fa),b.stroke()));(A[l].indexLabel||x.indexLabel||A[l].indexLabelFormatter||
x.indexLabelFormatter)&&this._indexLabels.push({chartType:x.type,dataPoint:A[l],dataSeries:x,point:{x:D+(B-D)/2,y:a.axisY.reversed?h:p},direction:1,bounds:{x1:D,y1:Math.min(h,p),x2:B,y2:Math.max(h,p)},color:e})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
l.y1,l.width,l.height),this._eventManager.ghostCtx.clip());for(var w=0,t=0;t<this.data.length;t++)!this.data[t].type.match(/(bar|column)/ig)||!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&w||w++;for(var x=0;x<a.dataSeriesIndexes.length;x++){var A=a.dataSeriesIndexes[x],C=this.data[A],D=C.dataPoints,B=s(C._linkedSeries)?!1:C._linkedSeries.type.match(/(bar|column)/ig)&&C._linkedSeries.visible?!0:!1,E=0;if(B)for(e=C._linkedSeries.id,t=0;t<e;t++)!this.data[t].type.match(/(bar|column)/ig)||
...
(t=e);t>u&&(t=u);if(0<D.length)for(var F=C._colorSet,u=0;u<D.length;u++){var e=C.lineColor=C.options.color?C.options.color:F[0],K={color:D[u].whiskerColor?D[u].whiskerColor:D[u].color?C.whiskerColor?C.whiskerColor:D[u].color:C.whiskerColor?C.whiskerColor:e,thickness:s(D[u].whiskerThickness)?C.whiskerThickness:D[u].whiskerThickness,dashType:D[u].whiskerDashType?D[u].whiskerDashType:C.whiskerDashType,length:s(D[u].whiskerLength)?s(C.options.whiskerLength)?t:C.options.whiskerLength:D[u].whiskerLength,
trimLength:s(D[u].whiskerLength)?s(C.options.whiskerLength)?50:0:0};K.length="number"===typeof K.length?0>=K.length?0:K.length>=t?t:K.length:"string"===typeof K.length?parseInt(K.length)*t/100>t?t:parseInt(K.length)*t/100>t:t;K.thickness="number"===typeof K.thickness?0>K.thickness?0:Math.round(K.thickness):2;var aa={color:D[u].stemColor?D[u].stemColor:D[u].color?C.stemColor?C.stemColor:D[u].color:C.stemColor?C.stemColor:e,thickness:D[u].stemThickness?D[u].stemThickness:C.stemThickness,dashType:D[u].stemDashType?
D[u].stemDashType:C.stemDashType};aa.thickness="number"===typeof aa.thickness?0>aa.thickness?0:Math.round(aa.thickness):2;D[u].getTime?r=D[u].x.getTime():r=D[u].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(D[u].y)&&D[u].y.length&&"number"===typeof D[u].y[0]&&"number"===typeof D[u].y[1]){var ja=a.axisX.convertValueToPixel(r);b?k=ja:h=ja;ja=a.axisY.convertValueToPixel(D[u].y[0]);b?n=ja:q=ja;ja=a.axisY.convertValueToPixel(D[u].y[1]);b?p=ja:g=ja;b?(q=a.axisX.reversed?k+(B?
w:1)*t/2-(B?E-1:0)*t<<0:k-(B?w:1)*t/2+(B?E-1:0)*t<<0,g=a.axisX.reversed?q-t<<0:q+t<<0):(n=a.axisX.reversed?h+(B?w:1)*t/2-(B?E-1:0)*t<<0:h-(B?w:1)*t/2+(B?E-1:0)*t<<0,p=a.axisX.reversed?n-t<<0:n+t<<0);!b&&q>g&&(ja=q,q=g,g=ja);b&&n>p&&(ja=n,n=p,p=ja);ja=C.dataPointIds[u];this._eventManager.objectMap[ja]={id:ja,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:u,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:aa,whiskerProperties:K};y(c,Math.min(n,
p),Math.min(q,g),Math.max(p,n),Math.max(g,q),e,K,aa,b);v&&y(this._eventManager.ghostCtx,n,q,p,g,e,K,aa,b);if(D[u].indexLabel||C.indexLabel||D[u].indexLabelFormatter||C.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:D[u],dataSeries:C,indexKeyword:0,point:{x:b?D[u].y[1]>=D[u].y[0]?n:p:n+(p-n)/2,y:b?q+(g-q)/2:D[u].y[1]>=D[u].y[0]?g:q},direction:D[u].y[1]>=D[u].y[0]?-1:1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),
this._indexLabels.push({chartType:"error",dataPoint:D[u],dataSeries:C,indexKeyword:1,point:{x:b?D[u].y[1]>=D[u].y[0]?p:n:n+(p-n)/2,y:b?q+(g-q)/2:D[u].y[1]>=D[u].y[0]?q:g},direction:D[u].y[1]>=D[u].y[0]?1:-1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
...
for(var u=0;u<a.dataSeriesIndexes.length;u++){var h=[],k=a.dataSeriesIndexes[u],n=this.data[k],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=Q(f);e.fillStyle=f;var f=[],q=!0,g=0,r,m,s,t,x=null;if(0<p.length){var w=n._colorSet[g%n._colorSet.length],C=n.lineColor=n.options.lineColor||w,D=C;b.fillStyle=w;b.strokeStyle=C;b.lineWidth=n.lineThickness;var B="solid";if(b.setLineDash){var y=O(n.nullDataLineDashType,n.lineThickness),B=n.lineDashType,E=O(B,
n.lineThickness);b.setLineDash(E)}for(var K=!0;g<p.length;g++)if(t=p[g].x.getTime?p[g].x.getTime():p[g].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!K)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(t);m=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);q||K?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||B===n.lineDashType&&
n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,B=n.nullDataLineDashType,b.setLineDash(y)),b.lineTo(r,m),v&&e.lineTo(r,m),h.push({x:r,y1:m,y2:s})):(b.beginPath(),b.moveTo(r,m),x={x:r,y:m},h=[],h.push({x:r,y1:m,y2:s}),v&&(e.beginPath(),e.moveTo(r,m))),K=q=!1):(b.lineTo(r,m),h.push({x:r,y1:m,y2:s}),v&&e.lineTo(r,m),0==g%250&&d());t=n.dataPointIds[g];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:m,y2:s};g<p.length-
1&&(D!==(p[g].lineColor||C)||B!==(p[g].lineDashType||n.lineDashType))&&(d(),D=p[g].lineColor||C,h[h.length-1].newStrokeStyle=D,b.strokeStyle=D,b.setLineDash&&(p[g].lineDashType?(B=p[g].lineDashType,h[h.length-1].newLineDashArray=O(B,n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(B=n.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(g,r,s,b);f.push(aa);var F=Q(t);v&&f.push({x:r,
y:s,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness});aa=n.getMarkerProperties(g,r,m,b);f.push(aa);F=Q(t);v&&f.push({x:r,y:m,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:r,y:m},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:w}),
this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:r,y:s},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:-1,color:w})}else K||q||d(),K=!0;d();W.drawMarkers(f)}}v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
{objectType:"dataSeries",dataSeriesIndex:m};f=Q(f);e.fillStyle=f;var f=[],p=0,q,g,r,s=[],y=[];if(0<n.length){var t=k._colorSet[p%k._colorSet.length],x=k.lineColor=k.options.lineColor||t,A=x;b.fillStyle=t;b.lineWidth=k.lineThickness;var C="solid",D;if(b.setLineDash){var B=O(k.nullDataLineDashType,k.lineThickness),C=k.lineDashType;D=O(C,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||
!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);r=a.axisY.convertValueToPixel(n[p].y[1]);var E=k.dataPointIds[p];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:p,x1:q,y1:g,y2:r};s[s.length]={x:q,y:g};y[y.length]={x:q,y:r};p<n.length-1&&(A!==(n[p].lineColor||x)||C!==(n[p].lineDashType||k.lineDashType))&&(A=n[p].lineColor||x,s[s.length-
1].newStrokeStyle=A,b.setLineDash&&(n[p].lineDashType?(C=n[p].lineDashType,s[s.length-1].newLineDashArray=O(C,k.lineThickness)):(C=k.lineDashType,s[s.length-1].newLineDashArray=D)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var F=k.getMarkerProperties(p,q,g,b);f.push(F);var K=Q(E);v&&f.push({x:q,y:g,ctx:e,type:F.type,size:F.size,color:K,borderColor:K,borderThickness:F.borderThickness});F=k.getMarkerProperties(p,q,r,b);f.push(F);K=Q(E);v&&f.push({x:q,y:r,ctx:e,type:F.type,size:F.size,
color:K,borderColor:K,borderThickness:F.borderThickness})}if(n[p].indexLabel||k.indexLabel||n[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:n[p].y[0]<=n[p].y[1]?-1:1,color:t}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:1,point:{x:q,y:r},direction:n[p].y[0]<=n[p].y[1]?1:-1,color:t});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&
(0<s.length&&(k.options.nullDataLineDashType||!n[p-1].lineDashType))&&(s[s.length-1].newLineDashArray=B,C=k.nullDataLineDashType):(d(D,x),s=[],y=[])),g=!0;d(D,x);W.drawMarkers(f)}}v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var r=a.dataSeriesIndexes[g],s=this.data[r],w=s.dataPoints,e=s._colorSet[0];s.risingColor=s.options.risingColor?s.options.risingColor:e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var t="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,x=1===Math.round(t)%2?-0.5:0;if(0<w.length)for(var A=5<q&&s.bevelEnabled?!0:!1,C=!1,y=null,B=null,l=0;l<w.length;l++)if(w[l].getTime?
n=w[l].x.getTime():n=w[l].x,"number"!==typeof w[l].y){if(0<l&&!C&&s.connectNullData)var E=s.options.nullDataLineDashType||!w[l-1].lineDashType?s.nullDataLineDashType:w[l-1].lineDashType;C=!0}else{h=a.axisX.convertValueToPixel(n);m=0===s.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);k=0===s.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);h=a.axisX.reversed?h+a.plotType.totalDataSeries*
q/2-(a.previousDataSeriesCount+g)*q<<0:h-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var F=a.axisX.reversed?h-q<<0:h+q<<0;m>k&&(e=m,m=k,k=e);a.axisY.reversed&&(e=m,m=k,k=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:l,x1:h,y1:m,x2:F,y2:k};var K=w[l].color?w[l].color:0<w[l].y?s.risingColor:s.fallingColor;ca(c,h,m,F,k,K,0,K,A,A,!1,!1,s.fillOpacity);e=Q(e);v&&ca(this._eventManager.ghostCtx,h,m,F,k,e,0,null,!1,
!1,!1,!1);var aa,K=h;aa="undefined"!==typeof w[l].isIntermediateSum&&!0===w[l].isIntermediateSum||"undefined"!==typeof w[l].isCumulativeSum&&!0===w[l].isCumulativeSum?0<w[l].y?m:k:0<w[l].y?k:m;0<l&&y&&(!C||s.connectNullData)&&(C&&c.setLineDash&&c.setLineDash(O(E,t)),c.beginPath(),c.moveTo(y,B-x),c.lineTo(K,aa-x),0<t&&c.stroke(),v&&(b.beginPath(),b.moveTo(y,B-x),b.lineTo(K,aa-x),0<t&&b.stroke()));C=!1;y=F;B=0<w[l].y?m:k;K=w[l].lineDashType?w[l].lineDashType:s.options.lineDashType?s.options.lineDashType:
"shortDash";c.strokeStyle=w[l].lineColor?w[l].lineColor:s.options.lineColor?s.options.lineColor:"#9e9e9e";c.lineWidth=t;c.setLineDash&&(K=O(K,t),c.setLineDash(K));(w[l].indexLabel||s.indexLabel||w[l].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:w[l],dataSeries:s,point:{x:h+(F-h)/2,y:0<=w[l].y?m:k},direction:0>w[l].y===a.axisY.reversed?1:-1,bounds:{x1:h,y1:Math.min(m,k),x2:F,y2:Math.max(m,k)},color:e})}}v&&(d.drawImage(this._preRenderCanvas,0,
...
f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,k,e):k.indexLabelFormatter?k.indexLabelFormatter(u):k.indexLabel?m.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";m._eventManager.objectMap[l]=p;p.center={x:A.x,y:A.y};p.y=f.y;p.radius=B;p.percentInnerRadius=F;p.indexLabelText=h;p.indexLabelPlacement=k.indexLabelPlacement;p.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:f.color?f.color:k._colorSet[e%
...
f.indexLabelWrap:k.indexLabelWrap;p.startAngle=0===e?k.startAngle?k.startAngle/180*Math.PI:0:g[e-1].endAngle;p.startAngle=(p.startAngle+2*Math.PI)%(2*Math.PI);p.endAngle=p.startAngle+2*Math.PI/C*Math.abs(f.y);f=(p.endAngle+p.startAngle)/2;f=(f+2*Math.PI)%(2*Math.PI);p.midAngle=f;if(p.midAngle>Math.PI/2-t&&p.midAngle<Math.PI/2+t){if(0===a||g[c].midAngle>p.midAngle)c=e;a++}else if(p.midAngle>3*Math.PI/2-t&&p.midAngle<3*Math.PI/2+t){if(0===b||g[d].midAngle>p.midAngle)d=e;b++}p.hemisphere=f>Math.PI/2&&
...
h.indexLabelTextBlock.height/2),c-u<r&&(l=u,p=f(p,l,d+1),+p.toFixed(x)<+l.toFixed(x)&&(k=c>r?c-r:u-(l-p)))));k&&(d=h.indexLabelTextBlock.y+k,c=0,c="right"===h.hemisphere?A.x+Math.sqrt(Math.pow(v,2)-Math.pow(d-A.y,2)):A.x-Math.sqrt(Math.pow(v,2)-Math.pow(d-A.y,2)),h.midAngle>Math.PI/2-t&&h.midAngle<Math.PI/2+t?(l=(a-1+g.length)%g.length,l=g[l],a=g[(a+1+g.length)%g.length],"left"===h.hemisphere&&"right"===l.hemisphere&&c>l.indexLabelTextBlock.x?c=l.indexLabelTextBlock.x-15:"right"===h.hemisphere&&("left"===
...
A.y,h.indexLabelTextBlock.x-A.x))}return k}function l(){var a=m.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,d=0,l=!0,c=0;10>c&&(1>c||0<d);c++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&B-d<=E)l=!1;l&&(B-=d);d=0;if("inside"!==k.indexLabelPlacement){v=B*w;for(a=0;a<n.length;a++){var h=g[a];h.indexLabelTextBlock.x=A.x+v*Math.cos(h.midAngle);h.indexLabelTextBlock.y=A.y+v*Math.sin(h.midAngle);h.indexLabelAngle=
h.midAngle;h.radius=B;h.percentInnerRadius=F}for(var u,s,a=0;a<n.length;a++){var h=g[a],t=e(a);if(null!==t){u=g[a];s=g[t];var C=0,C=b(u,s)-r;if(0>C){for(var y=s=0,D=0;D<n.length;D++)D!==a&&g[D].hemisphere===h.hemisphere&&(g[D].indexLabelTextBlock.y<h.indexLabelTextBlock.y?s++:y++);s=C/(s+y||1)*y;var y=-1*(C-s),J=D=0;"right"===h.hemisphere?(D=f(a,s),y=-1*(C-D),J=f(t,y),+J.toFixed(x)<+y.toFixed(x)&&+D.toFixed(x)<=+s.toFixed(x)&&f(a,-(y-J))):(D=f(t,s),y=-1*(C-D),J=f(a,y),+J.toFixed(x)<+y.toFixed(x)&&
+D.toFixed(x)<=+s.toFixed(x)&&f(t,-(y-J)))}}}}else for(a=0;a<n.length;a++)h=g[a],v="pie"===k.type?0.7*B:0.8*B,t=A.x+v*Math.cos(h.midAngle),s=A.y+v*Math.sin(h.midAngle),h.indexLabelTextBlock.x=t,h.indexLabelTextBlock.y=s;for(a=0;a<n.length;a++)if(h=g[a],t=h.indexLabelTextBlock.measureText(),0!==t.height&&0!==t.width)t=t=0,"right"===h.hemisphere?(t=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+p),t*=-1):t=q.x1-(h.indexLabelTextBlock.x-h.indexLabelTextBlock.width-p),0<t&&(!l&&h.indexLabelText&&
(s="right"===h.hemisphere?q.x2-h.indexLabelTextBlock.x:h.indexLabelTextBlock.x-q.x1,0.3*h.indexLabelTextBlock.maxWidth>s?h.indexLabelText="":h.indexLabelTextBlock.maxWidth=0.85*s,0.3*h.indexLabelTextBlock.maxWidth<s&&(h.indexLabelTextBlock.x-="right"===h.hemisphere?2:-2)),Math.abs(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-A.y)<B||Math.abs(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2-A.y)<B)&&(t/=Math.abs(Math.cos(h.indexLabelAngle)),9<t&&(t*=0.3),t>d&&(d=t)),t=t=0,0<h.indexLabelAngle&&
h.indexLabelAngle<Math.PI?(t=q.y2-(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+5),t*=-1):t=q.y1-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-5),0<t&&(!l&&h.indexLabelText&&(s=0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?-1:1,0===f(a,t*s)&&f(a,2*s)),Math.abs(h.indexLabelTextBlock.x-A.x)<B&&(t/=Math.abs(Math.sin(h.indexLabelAngle)),9<t&&(t*=0.3),t>d&&(d=t)));var H=function(a,b,c){for(var d=[],e=0;d.push(g[b]),b!==c;b=(b+1+n.length)%n.length);d.sort(function(a,b){return a.y-b.y});
for(b=0;b<d.length;b++)if(c=d[b],e<0.7*a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,c=-1,d=0,f=!1,k=0;k<n.length;k++)if(f=!1,u=g[k],u.indexLabelText){var l=e(k);if(null!==l){var h=g[l];C=0;C=b(u,h);var q;if(q=0>C){q=u.indexLabelTextBlock.x;var m=u.indexLabelTextBlock.y-u.indexLabelTextBlock.height/2,r=u.indexLabelTextBlock.y+u.indexLabelTextBlock.height/2,s=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/
2,t=h.indexLabelTextBlock.x+h.indexLabelTextBlock.width,z=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2;q=u.indexLabelTextBlock.x+u.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>t+p||m>z+p||r<s-p?!1:!0}q?(0>a&&(a=k),l!==a&&(c=l,d+=-C),0===k%Math.max(n.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(H(d,a,c),c=a=-1,d=0)}}0<d&&H(d,a,c)})()}}function h(){m.plotArea.layoutManager.reset();m.title&&(m.title.dockInsidePlotArea||"center"===m.title.horizontalAlign&&"center"===m.title.verticalAlign)&&
...
typeof x[c].y?x[c].y:0;a+=Math.abs(x[c].y)}if(0===a)return-1;for(c=b[0]=0;c<x.length;c++)b.push(Math.abs(x[c].y)*E/a);return b}function c(){var a=V,b=Z,c=M,d=W,e,f;e=Y;f=R-ba;d=Math.abs((f-e)*(b-a+(d-c))/2);c=W-M;e=f-e;f=c*(f-R);f=Math.abs(f);f=d+f;for(var d=[],g=0,k=0;k<x.length;k++){if("undefined"===typeof x[k].y)return-1;x[k].y="number"===typeof x[k].y?x[k].y:0;g+=Math.abs(x[k].y)}if(0===g)return-1;for(var l=d[0]=0,n=0,h,p,b=b-a,l=!1,k=0;k<x.length;k++)a=Math.abs(x[k].y)*f/g,l?h=0==Number(c.toFixed(3))?
0:a/c:(p=$*$*b*b-4*Math.abs($)*a,0>p?(p=c,l=(b+p)*(e-n)/2,a-=l,h=e-n,n+=e-n,h+=0==p?0:a/p,n+=a/p,l=!0):(h=(Math.abs($)*b-Math.sqrt(p))/2,p=b-2*h/Math.abs($),n+=h,n>e&&(n-=h,p=c,l=(b+p)*(e-n)/2,a-=l,h=e-n,n+=e-n,h+=a/p,n+=a/p,l=!0),b=p)),d.push(h);return d}function b(){if(t&&x){for(var a,b,c,d,e,f,k,l,n,h,p,q,u,m,r=[],z=[],w={percent:null,total:null},C=null,A=0;A<x.length;A++)m=P[A],m="undefined"!==typeof m.x5?(m.y2+m.y4)/2:(m.y2+m.y3)/2,m=g(m).x2+1,r[A]=N-m-U;m=0.5*U;for(var A=0,B=x.length-1;A<x.length||
0<=B;A++,B--){b=t.reversed?x[B]:x[A];a=b.color?b.color:t.reversed?t._colorSet[(x.length-1-A)%t._colorSet.length]:t._colorSet[A%t._colorSet.length];c=b.indexLabelPlacement||t.indexLabelPlacement||"outside";d=b.indexLabelBackgroundColor||t.indexLabelBackgroundColor||(v?"transparent":null);e=b.indexLabelFontColor||t.indexLabelFontColor||"#979797";f=s(b.indexLabelFontSize)?t.indexLabelFontSize:b.indexLabelFontSize;k=b.indexLabelFontStyle||t.indexLabelFontStyle||"normal";l=b.indexLabelFontFamily||t.indexLabelFontFamily||
"arial";n=b.indexLabelFontWeight||t.indexLabelFontWeight||"normal";a=b.indexLabelLineColor||t.options.indexLabelLineColor||a;h="number"===typeof b.indexLabelLineThickness?b.indexLabelLineThickness:"number"===typeof t.indexLabelLineThickness?t.indexLabelLineThickness:2;p=b.indexLabelLineDashType||t.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof t.indexLabelWrap?t.indexLabelWrap:!0;u=t.dataPointIds[A];y._eventManager.objectMap[u]={id:u,
objectType:"dataPoint",dataPointIndex:A,dataSeriesIndex:0,funnelSection:P[t.reversed?x.length-1-A:A]};"inside"===t.indexLabelPlacement&&(r[A]=A!==ca?t.reversed?P[A].x2-P[A].x1:P[A].x3-P[A].x4:P[A].x3-P[A].x6,20>r[A]&&(r[A]=A!==ca?t.reversed?P[A].x3-P[A].x4:P[A].x2-P[A].x1:P[A].x2-P[A].x1,r[A]/=2));u=b.indexLabelMaxWidth?b.indexLabelMaxWidth:t.options.indexLabelMaxWidth?t.indexLabelMaxWidth:r[A];if(u>r[A]||0>u)u=r[A];z[A]="inside"===t.indexLabelPlacement?P[A].height:!1;w=y.getPercentAndTotal(t,b);
if(t.indexLabelFormatter||b.indexLabelFormatter)C={chart:y.options,dataSeries:t,dataPoint:b,total:w.total,percent:w.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(C):b.indexLabel?y.replaceKeywordsWithValue(b.indexLabel,b,t,A):t.indexLabelFormatter?t.indexLabelFormatter(C):t.indexLabel?y.replaceKeywordsWithValue(t.indexLabel,b,t,A):b.label?b.label:"";0>=h&&(h=0);1E3>u&&1E3-u<m&&(u+=1E3-u);Q.roundRect||za(Q);c=new ia(Q,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:n,horizontalAlign:c,
backgroundColor:d,maxWidth:u,maxHeight:!1===z[A]?q?4.28571429*f:1.5*f:z[A],text:b,padding:da});c.measureText();I.push({textBlock:c,id:t.reversed?B:A,isDirty:!1,lineColor:a,lineThickness:h,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,k=N-Z-U/2,k=t.options.indexLabelMaxWidth?t.indexLabelMaxWidth>k?k:t.indexLabelMaxWidth:k,l=I.length-1;0<=l;l--){g=x[I[l].id];c=I[l];d=c.textBlock;b=(a=
q(l)<P.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+da>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=P[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=N-k,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?
(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,t.reversed?(I[l].textBlock.y+I[l].height>S+C&&(I[l].textBlock.y=S+C-I[l].height),I[l].textBlock.y<qa-C&&(I[l].textBlock.y=qa-C)):(I[l].textBlock.y<S-C&&(I[l].textBlock.y=S-C),I[l].textBlock.y+I[l].height>qa+C&&(I[l].textBlock.y=qa+C-I[l].height))}function f(){var a,b,c,d;if("inside"!==t.indexLabelPlacement)for(var e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/
2,b=t.reversed?"undefined"!==typeof a.x5?c>va?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<va?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+U,I[e].textBlock.y=c-I[e].height/2,t.reversed?(I[e].textBlock.y+I[e].height>S+C&&(I[e].textBlock.y=S+C-I[e].height),I[e].textBlock.y<qa-C&&(I[e].textBlock.y=qa-C)):(I[e].textBlock.y<S-C&&(I[e].textBlock.y=S-C),I[e].textBlock.y+I[e].height>qa+C&&(I[e].textBlock.y=qa+C-I[e].height)));else for(e=0;e<P.length;e++)0==I[e].textBlock.text.length?
I[e].isDirty=!0:(a=P[e],b=a.height,c=I[e].height,d=I[e].width,b>=c?(b=e!=ca?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ca?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,I[e].textBlock.x=b,I[e].textBlock.y=c):I[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=I.length)return 0;var e,f=I[b].textBlock;if(0>c){c*=-1;e=p(b);d=h(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=h(b,e);if(d>=c)return f.y+=c,c;if(b==P.length-1)return 0<d&&(f.y+=d),d;
d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,k;f=(R-Y+2*C)/n;k=n;for(var l,h=1;h<k;h++){e=h*f;for(var u=I.length-1;0<=u;u--)!I[u].isDirty&&(I[u].textBlock.y<e&&I[u].textBlock.y+I[u].height>e)&&(l=q(u),!(l>=I.length-1)&&I[u].textBlock.y+I[u].height+da>I[l].textBlock.y&&(I[u].textBlock.y=I[u].textBlock.y+I[u].height-e>e-I[u].textBlock.y?e+1:e-I[u].height-1))}for(l=P.length-1;0<l;l--)if(!I[l].isDirty){e=p(l);if(0>e&&(e=0,I[e].isDirty))break;if(I[l].textBlock.y<I[e].textBlock.y+I[e].height){d=
d||l;f=l;for(k=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+da;){a=a||I[f].textBlock.y+I[f].height;k+=I[f].height;k+=da;f=e;if(0>=f){f=0;k+=I[f].height;break}e=p(f);if(0>e){f=0;k+=I[f].height;break}}if(f!=l){g=I[f].textBlock.y;a-=g;a=k-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=b;d++)e.push(P[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=I[b.id].height+da,I[b.id].textBlock.text="",I[b.id].indexLabelText=
"",I[b.id].isDirty=!0,I[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,k,l,n=1,m=0;m<2*n;m++){for(var r=I.length-1;0<=r&&!(0<=p(r)&&p(r),f=I[r],g=f.textBlock,l=(k=q(r)<P.length?I[q(r)]:null)?k.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(k&&e+d+da>+l.y.toFixed(6))&&(d=g.y+d+da-l.y,e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<P.length?I[b].textBlock.y:t.reversed?S+C:qa+C)-(0>a?t.reversed?qa-C:S-C:I[a].textBlock.y+I[a].height+
da)}function m(a,b,c){var d,e,g,l=[],h=C,p=[];-1!==b&&(0<=X.indexOf(b)?(e=X.indexOf(b),X.splice(e,1)):(X.push(b),X=X.sort(function(a,b){return a-b})));if(0===X.length)l=ga;else{e=C*(1!=X.length||0!=X[0]&&X[0]!=P.length-1?2:1)/k();for(var q=0;q<P.length;q++){if(1==X.length&&0==X[0]){if(0===q){l.push(ga[q]);d=h;continue}}else 0===q&&(d=-1*h);l.push(ga[q]+d);if(0<=X.indexOf(q)||q<P.length&&0<=X.indexOf(q+1))d+=e}}g=function(){for(var a=[],b=0;b<P.length;b++)a.push(l[b]-P[b].y1);return a}();var u={startTime:(new Date).getTime(),
duration:c||500,easingFunction:function(a,b,c,d){return L.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<P.length;d++)b=g[d],c=P[d],b*=a,"undefined"===typeof p[d]&&(p[d]=0),0>p&&(p*=-1),c.y1+=b-p[d],c.y2+=b-p[d],c.y3+=b-p[d],c.y4+=b-p[d],c.y5&&(c.y5+=b-p[d],c.y6+=b-p[d]),p[d]=b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ha=!0;d.clearRect(A.x1,A.y1,A.x2-A.x1,A.y2-A.y1);d.fillStyle=a.backgroundColor;d.fillRect(A.x1,A.y1,A.width,A.height);u.changeSection(c,
b);var e={};e.dataSeries=t;e.dataPoint=t.reversed?t.dataPoints[x.length-1-b]:t.dataPoints[b];e.index=t.reversed?x.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<P.length;e++)oa(d,P[e],t.fillOpacity);w(d);K&&("inside"!==t.indexLabelPlacement?n(d):f(),r(d));1<=c&&(ha=!1)},null,L.easing.easeOutQuart)}function k(){for(var a=0,b=0;b<P.length-1;b++)(0<=X.indexOf(b)||0<=X.indexOf(b+1))&&a++;return a}function n(a){for(var b,c,d,e,f=0;f<P.length;f++)e=1===I[f].lineThickness%2?0.5:0,c=((P[f].y2+P[f].y4)/
2<<0)+e,b=g(c).x2-1,d=I[f].textBlock.x,e=(I[f].textBlock.y+I[f].height/2<<0)+e,I[f].isDirty||0==I[f].lineThickness||(a.strokeStyle=I[f].lineColor,a.lineWidth=I[f].lineThickness,a.setLineDash&&a.setLineDash(O(I[f].lineDashType,I[f].lineThickness)),a.beginPath(),a.moveTo(b,c),a.lineTo(d,e),a.stroke())}function p(a){for(a-=1;-1<=a&&-1!=a&&I[a].isDirty;a--);return a}function q(a){for(a+=1;a<=P.length&&a!=P.length&&I[a].isDirty;a++);return a}function g(a){for(var b,c=0;c<x.length;c++)if(P[c].y1<a&&P[c].y4>
a){b=P[c];break}return b?(a=b.y6?a>b.y6?b.x3+(b.x4-b.x3)/(b.y4-b.y3)*(a-b.y3):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2),{x1:a,x2:a}):-1}function r(a){for(var b=0;b<P.length;b++)I[b].isDirty||(a&&(I[b].textBlock.ctx=a),I[b].textBlock.render(!0))}function w(a){y.plotArea.layoutManager.reset();a.roundRect||za(a);y.title&&(y.title.dockInsidePlotArea||"center"===y.title.horizontalAlign&&"center"===y.title.verticalAlign)&&(y.title.ctx=a,y.title.render());if(y.subtitles)for(var b=
0;b<y.subtitles.length;b++){var c=y.subtitles[b];if(c.dockInsidePlotArea||"center"===c.horizontalAlign&&"center"===c.verticalAlign)y.subtitles.ctx=a,c.render()}y.legend&&(y.legend.dockInsidePlotArea||"center"===y.legend.horizontalAlign&&"center"===y.legend.verticalAlign)&&(y.legend.ctx=a,y.legend.setLayout(),y.legend.render());J.fNg&&J.fNg(y)}var y=this;if(!(0>=a.dataSeriesIndexes.length)){for(var t=this.data[a.dataSeriesIndexes[0]],x=t.dataPoints,A=this.plotArea,C=0.025*A.width,D=0.01*A.width,B=
0,E=A.height-2*C,F=Math.min(A.width-2*D,2.8*A.height),K=!1,H=0;H<x.length;H++)if(!K&&("undefined"!==typeof x[H].indexLabel&&null!==x[H].indexLabel&&0<x[H].indexLabel.toString().length)&&(K=!0),!K&&("undefined"!==typeof x[H].label&&null!==x[H].label&&0<x[H].label.toString().length)&&(K=!0),!K&&"function"===typeof t.indexLabelFormatter||"function"===typeof x[H].indexLabelFormatter)K=!0;K=K||"undefined"!==typeof t.indexLabel&&null!==t.indexLabel&&0<t.indexLabel.toString().length;"inside"!==t.indexLabelPlacement&&
K||(D=(A.width-0.75*F)/2);var H=A.x1+D,N=A.x2-D,Y=A.y1+C,R=A.y2-C,Q=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=t.length&&(t.dataPoints&&t.visible)&&0!==x.length){var ba,G;a=75*F/100;var U=30*(N-a)/100;"funnel"===t.type?(ba=s(t.options.neckHeight)?0.35*E:t.neckHeight,G=s(t.options.neckWidth)?0.25*a:t.neckWidth,"string"===typeof ba&&ba.match(/%$/)?(ba=parseInt(ba),ba=ba*E/100):ba=parseInt(ba),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),ba>E?ba=E:0>=ba&&(ba=0),
G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===t.type&&(G=ba=0,t.reversed=t.reversed?!1:!0);var D=H+a/2,V=H,Z=H+a,S=t.reversed?R:Y,M=D-G/2,W=D+G/2,va=t.reversed?Y+ba:R-ba,qa=t.reversed?Y:R;a=[];var D=[],P=[],F=[],T=Y,ca,$=(va-S)/(M-V),ea=-$,H="area"===(t.valueRepresents?t.valueRepresents:"height")?c():d();if(-1!==H){if(t.reversed)for(F.push(T),G=H.length-1;0<G;G--)T+=H[G],F.push(T);else for(G=0;G<H.length;G++)T+=H[G],F.push(T);if(t.reversed)for(G=0;G<H.length;G++)F[G]<va?(a.push(M),D.push(W),ca=G):(a.push((F[G]-
S+$*V)/$),D.push((F[G]-S+ea*Z)/ea));else for(G=0;G<H.length;G++)F[G]<va?(a.push((F[G]-S+$*V)/$),D.push((F[G]-S+ea*Z)/ea),ca=G):(a.push(M),D.push(W));for(G=0;G<H.length-1;G++)T=t.reversed?x[x.length-1-G].color?x[x.length-1-G].color:t._colorSet[(x.length-1-G)%t._colorSet.length]:x[G].color?x[G].color:t._colorSet[G%t._colorSet.length],G===ca?P.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:W,y3:va,x4:D[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],x6:M,y6:va,id:G,height:F[G+1]-F[G],color:T}):P.push({x1:a[G],y1:F[G],
x2:D[G],y2:F[G],x3:D[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:T});var da=2,I=[],ha=!1,X=[],ga=[],H=!1;a=a=0;Aa(X);for(G=0;G<x.length;G++)x[G].exploded&&(H=!0,t.reversed?X.push(x.length-1-G):X.push(G));Q.clearRect(A.x1,A.y1,A.width,A.height);Q.fillStyle=y.backgroundColor;Q.fillRect(A.x1,A.y1,A.width,A.height);if(K&&t.visible&&(b(),f(),e(),"inside"!==t.indexLabelPlacement)){l();for(G=0;G<x.length;G++)I[G].isDirty||(a=I[G].textBlock.x+I[G].width,a=(N-a)/2,0==G&&(B=a),B>a&&(B=
a));for(G=0;G<P.length;G++)P[G].x1+=B,P[G].x2+=B,P[G].x3+=B,P[G].x4+=B,P[G].x5&&(P[G].x5+=B,P[G].x6+=B),I[G].textBlock.x+=B}for(G=0;G<P.length;G++)B=P[G],oa(Q,B,t.fillOpacity),ga.push(B.y1);w(Q);K&&t.visible&&("inside"===t.indexLabelPlacement||y.animationEnabled||n(Q),y.animationEnabled||r());if(!K)for(G=0;G<x.length;G++)B=t.dataPointIds[G],a={id:B,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:P[t.reversed?x.length-1-G:G]},y._eventManager.objectMap[B]=a;!y.animationEnabled&&
H?m(y,-1,0):y.animationEnabled&&!y.animatedRender&&m(y,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ha&&!y.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=t.reversed?x.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===t.type||"pyramid"===t.type)t.reversed?x[x.length-1-a].exploded=x[x.length-1-a].exploded?!1:!0:x[a].exploded=x[a].exploded?!1:!0;m(y,b,500)}};return{source:Q,dest:this.plotArea.ctx,animationCallback:function(a,b){L.fadeInAnimation(a,
...
v)):0;"error"===p.type&&this.errorMarkerColor.push(r);g=this.chart.replaceKeywordsWithValue(g,p.dataPoints[0],p,n);q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:v,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:w,markerBorderThickness:t};m.push(q)}else for(var x=0;x<p.dataPoints.length;x++){var A=p.dataPoints[x],q=A.legendMarkerType?A.legendMarkerType:p.legendMarkerType?p.legendMarkerType:H.getDefaultLegendMarker(p.type),g=A.legendText?
A.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:A}):A.name?A.name:"DataPoint: "+(x+1),r=A.legendMarkerColor?A.legendMarkerColor:p.legendMarkerColor?p.legendMarkerColor:A.color?A.color:p.color?p.color:p._colorSet[x%p._colorSet.length],v=0.75*this.lineHeight,w=A.legendMarkerBorderColor?A.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:A.markerBorderColor?A.markerBorderColor:
p.markerBorderColor,t=A.legendMarkerBorderThickness?A.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:A.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*v)):0,g=this.chart.replaceKeywordsWithValue(g,A,p,x),q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:v,dataSeriesIndex:n,dataPointIndex:x,markerBorderColor:w,markerBorderThickness:t};(A.showInLegend||p.showInLegend&&!1!==A.showInLegend)&&m.push(q)}}!0===
this.reversed&&m.reverse();if(0<m.length){p=null;r=g=A=x=0;A=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=f;v=0===v?0.75*this.lineHeight:v;A-=v+h;for(n=0;n<m.length;n++){q=m[n];w=A;if("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType)w-=2*0.1*this.lineHeight;if(!(0>=l||"undefined"===typeof l||0>=w||"undefined"===typeof w)){if("horizontal"===
...
q.x1=this.chart._eventManager.objectMap[q.id].x1=s;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}h+=n}};ma(H,V);H.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===
...
this.interval),e=Ta(new Date(this.viewportMaximum),this.interval,this.intervalType),g=q,c=this.intervalStartPosition;c<e;Ta(c,b,this.intervalType)){for(a=c.getTime();g<p.length&&a>p[g].endValue;g++);n=a;a=g<p.length&&a>=p[g].startValue&&a<=p[g].endValue;a||(a=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.options,value:new Date(n),label:this.labels[n]?this.labels[n]:null}):"axisX"===this.type&&this.labels[n]?this.labels[n]:ya(n,this.valueFormatString,this.chart._cultureInfo),
...
q[g].scaleBreaks._appliedBreaks.length)for(var r=q[g].scaleBreaks._appliedBreaks,v=0;v<r.length&&!(r[v].startValue>q[g].viewportMaximum);v++)r[v].endValue<q[g].viewportMinimum||(s(q[g].scaleBreaks.firstBreakIndex)&&(q[g].scaleBreaks.firstBreakIndex=v),r[v].startValue>=q[g].viewPortMinimum&&(q[g].scaleBreaks.lastBreakIndex=v));for(var w=v=0,t=0,x=0,A=0,y=0,D=0,B,E,F=h=0,H,J,L,r=H=J=L=!1,g=0;g<q.length;g++)q[g]&&q[g].title&&(q[g]._titleTextBlock=new ia(q[g].ctx,{text:q[g].title,horizontalAlign:"center",
fontSize:q[g].titleFontSize,fontFamily:q[g].titleFontFamily,fontWeight:q[g].titleFontWeight,fontColor:q[g].titleFontColor,fontStyle:q[g].titleFontStyle,borderColor:q[g].titleBorderColor,borderThickness:q[g].titleBorderThickness,backgroundColor:q[g].titleBackgroundColor,cornerRadius:q[g].titleCornerRadius,textBaseline:"top"}));for(g=0;g<q.length;g++)if(q[g].title)switch(q[g]._position){case "left":q[g]._titleTextBlock.maxWidth=q[g].titleMaxWidth||f.height;q[g]._titleTextBlock.maxHeight=q[g].titleWrap?
0.8*f.width:1.5*q[g].titleFontSize;q[g]._titleTextBlock.angle=-90;break;case "right":q[g]._titleTextBlock.maxWidth=q[g].titleMaxWidth||f.height;q[g]._titleTextBlock.maxHeight=q[g].titleWrap?0.8*f.width:1.5*q[g].titleFontSize;q[g]._titleTextBlock.angle=90;break;default:q[g]._titleTextBlock.maxWidth=q[g].titleMaxWidth||f.width,q[g]._titleTextBlock.maxHeight=q[g].titleWrap?0.8*f.height:1.5*q[g].titleFontSize,q[g]._titleTextBlock.angle=0}if("normal"===e){for(var x=[],A=[],y=[],D=[],N=[],O=[],Q=[],R=[];4>
v;){var G=0,U=0,S=0,V=0,X=e=0,M=0,Z=0,T=0,W=0,P=0,$=0;if(c&&0<c.length)for(y=[],g=P=0;g<c.length;g++)y.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateWidth():0)),P+=y[g],M+=c[g]&&!n.isNavigator?c[g].margin:0;else y.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));Q.push(y);if(b&&0<b.length)for(D=[],g=$=0;g<b.length;g++)D.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateWidth():0)),$+=D[g],Z+=b[g]?b[g].margin:0;else D.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));R.push(D);
l=Math.round(f.x1+P+M);m=Math.round(f.x2-$-Z>n.width-p?n.width-p:f.x2-$-Z);if(a&&0<a.length)for(x=[],g=T=0;g<a.length;g++)a[g]&&(a[g].lineCoordinates={}),a[g].lineCoordinates.width=Math.abs(m-l),a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.width?a[g].titleMaxWidth:a[g].lineCoordinates.width),x.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateHeight():0)),T+=x[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else x.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():
0));N.push(x);if(d&&0<d.length)for(A=[],g=W=0;g<d.length;g++)d[g]&&(d[g].lineCoordinates={}),d[g].lineCoordinates.width=Math.abs(m-l),d[g].title&&(d[g]._titleTextBlock.maxWidth=0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.width?d[g].titleMaxWidth:d[g].lineCoordinates.width),A.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateHeight():0)),W+=A[g],X+=d[g]&&!n.isNavigator?d[g].margin:0;else A.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateHeight():0));O.push(A);if(a&&0<a.length)for(g=
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||s(B)||s(E)||n.isNavigator||n.stockChart)||(h=0,0<a[g].labelAngle?E+t>m&&(h+=0<a[g].labelAngle?E+t-m-$:0):0>a[g].labelAngle?B-w<l&&B-w<a[g].viewportMinimum&&(F=l-(M+a[g].tickLength+y+B-w+a[g].labelFontSize/2)):0===a[g].labelAngle&&(E+t>m&&(h=E+t/2-m-$),B-w<l&&B-w<a[g].viewportMinimum&&(F=l-M-a[g].tickLength-y-B+w/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),n.panEnabled?W=s(n.sessionVariables.axisX2.height)?n.sessionVariables.axisX2.height=W:n.sessionVariables.axisX2.height:n.sessionVariables.axisX2.height=W,h=Math.round(f.y1),k=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=h+W+X-U,d[g].lineCoordinates.y2=h,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-A[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:l,y1:h+(W+
X-A[g]-U),x2:m,y2:k,width:m-l,height:k-h},U+=A[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)M=n.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+W+X<Math.max(M,p)?Math.max(M,p):f.y1+W+X),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:p,k=Math.round(f.y2-T-e-M),c[g].lineCoordinates={x1:l-S,y1:h,x2:m-S,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(y[g]-c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(y[g]+S),y1:h,x2:m,y2:k,width:m-l,height:k-h},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),S+=y[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),M=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+W+X<Math.max(M,p)?Math.max(M,p):f.y1+W+X),M=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(T+e+M)),b[g].lineCoordinates=
...
b[g].lineCoordinates.height),V+=D[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++)a[g]&&(a[g].calculateValueToPixelConversionParameters(),a[g].calculateBreaksSizeInValues(),a[g]._labels&&1<a[g]._labels.length&&(B=(a[g].logarithmic?Math.log(a[g]._labels[1].position/a[g].viewportMinimum)/a[g].conversionParameters.lnLogarithmBase:a[g]._labels[1].position-a[g].viewportMinimum)*Math.abs(a[g].conversionParameters.pixelPerUnit)+a[g].lineCoordinates.x1,l=a[g]._labels[a[g]._labels.length-("dateTime"===
a[g].valueType?2:1)].position,l=a[g].getApparentDifference(a[g].viewportMinimum,l),E=a[g].logarithmic?(1<l?Math.log(l)/a[g].conversionParameters.lnLogarithmBase*Math.abs(a[g].conversionParameters.pixelPerUnit):0)+a[g].lineCoordinates.x1:(0<l?l*Math.abs(a[g].conversionParameters.pixelPerUnit):0)+a[g].lineCoordinates.x1));if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateValueToPixelConversionParameters(),d[g].calculateBreaksSizeInValues(),d[g]._labels&&1<d[g]._labels.length&&(B=(d[g].logarithmic?
...
(0<l?l*Math.abs(d[g].conversionParameters.pixelPerUnit):0)+d[g].lineCoordinates.x1);for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<v){if(a&&0<a.length)for(g=0;g<a.length;g++)r=N[v-1][g]===N[v][g]?!0:!1;else r=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=O[v-1][g]===O[v][g]?!0:!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=Q[v-1][g]===Q[v][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)L=R[v-
...
[];B=[];F=[];w=[];E=[];t=[];N=[];for(O=[];4>v;){T=V=U=S=Z=M=X=e=R=Q=G=W=0;if(a&&0<a.length)for(F=[],g=V=0;g<a.length;g++)F.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),V+=F[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else F.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));N.push(F);if(d&&0<d.length)for(w=[],g=T=0;g<d.length;g++)w.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),T+=w[g],X+=d[g]?d[g].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));O.push(w);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+V+e),m=Math.round(f.x2-T-X>n.width-10?n.width-10:f.x2-T-X),c[g].labelAutoFit&&!s(x)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,x):0===c[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-A/2:0===c[g].labelAngle?m-A/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+V+e),m=Math.round(f.x2-T-X>b[g].chart.width-10?b[g].chart.width-10:f.x2-T-X),b[g]&&b[g].labelAutoFit&&!s(y)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,y):0===b[g].labelAngle?Math.max(l,y/2):l),0<!d.length&&(m-=D/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(p=[],g=S=0;g<c.length;g++)p.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),S+=p[g]+c[g].margin,M+=c[g].margin;else p.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));E.push(p);if(b&&0<b.length)for(B=[],g=U=0;g<b.length;g++)B.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateHeight():0)),U+=B[g],Z+=b[g].margin;else B.push(Math.ceil(b[0]?
...
Math.max(M,10)?Math.max(M,10):f.y1):f.y1<Math.max(M,10)?Math.max(M,10):f.y1;m=Math.round(f.x2-T-X);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-S>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2-S):f.y2>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(m=0>c[M].labelAngle?Math.max(m,x):0===c[M].labelAngle?Math.max(m,x/2):m,l=0>c[M].labelAngle||0===c[M].labelAngle?m-T:l);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&
...
0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.height?d[g].titleMaxWidth:d[g].lineCoordinates.height);d[g].calculateValueToPixelConversionParameters();d[g].calculateBreaksSizeInValues();R+=w[g]+d[g].margin}for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<v){if(a&&0<a.length)for(g=0;g<a.length;g++)r=N[v-1][g]===N[v][g]?!0:!1;else r=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=O[v-1][g]===O[v][g]?!0:
!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=E[v-1][g]===E[v][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)L=t[v-1][g]===t[v][g]?!0:!1;else L=!0}if(r&&H&&J&&L)break;v++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),
...
this.conversionParameters.maximum/this.conversionParameters.minimum:this.conversionParameters.maximum-this.conversionParameters.minimum),b=this.scaleBreaks&&!s(this.scaleBreaks.options.spacing),e,f=0;f<d.length;f++)e=b||!s(d[f].options.spacing),d[f].spacing=Pa(d[f].spacing,a,8,e?0.1*a:8,e?0:3)<<0,d[f].size=0>d[f].spacing?0:Math.abs(d[f].spacing/c),this.logarithmic&&(d[f].size=Math.pow(this.logarithmBase,d[f].size))};E.prototype.calculateBreaksInPixels=function(){if(!(this.scaleBreaks&&0>=this.scaleBreaks._appliedBreaks.length)){var a=
...
d.lineWidth=this.lineThickness;d.strokeStyle=this.lineColor?this.lineColor:"black";d.setLineDash&&d.setLineDash(O(this.lineDashType,this.lineThickness));var l=1===this.lineThickness%2?(this.lineCoordinates.y1<<0)+0.5:this.lineCoordinates.y1<<0;d.beginPath();if(this.scaleBreaks&&!s(this.scaleBreaks.firstBreakIndex))if(s(this.scaleBreaks.lastBreakIndex))e=this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel+b;else for(var h=this.scaleBreaks.firstBreakIndex;h<=this.scaleBreaks.lastBreakIndex;h++)d.moveTo(e,
...
E.prototype.getLabelStartPoint=function(){var a=R[this.intervalType+"Duration"]*this.interval,a=new Date(Math.floor(this.viewportMinimum/a)*a);if("millisecond"!==this.intervalType)if("second"===this.intervalType)0<a.getMilliseconds()&&(a.setSeconds(a.getSeconds()+1),a.setMilliseconds(0));else if("minute"===this.intervalType){if(0<a.getSeconds()||0<a.getMilliseconds())a.setMinutes(a.getMinutes()+1),a.setSeconds(0),a.setMilliseconds(0)}else if("hour"===this.intervalType){if(0<a.getMinutes()||0<a.getSeconds()||
...
a.setSeconds(0),a.setMilliseconds(0));return a};ma(S,V);ma(T,V);T.prototype.createUserOptions=function(a){if("undefined"!==typeof a||this.options._isPlaceholder){var d=0;this.parent.options._isPlaceholder&&this.parent.createUserOptions();this.options._isPlaceholder||(Aa(this.parent[this.optionsName]),d=this.parent.options[this.optionsName].indexOf(this.options));this.options="undefined"===typeof a?{}:a;this.parent.options[this.optionsName][d]=this.options}};T.prototype.render=function(a){if(0!==this.spacing||
0!==this.options.lineThickness&&("undefined"!==typeof this.options.lineThickness||0!==this.parent.lineThickness)){var d=this.ctx,c=this.ctx.globalAlpha;this.ctx=a||this.ctx;this.ctx.save();this.ctx.beginPath();this.ctx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height);this.ctx.clip();var b=this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.startValue),e=this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.endValue);this.ctx.strokeStyle=
this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;Q(this.id);var f,l,h,m,k,n;a=Math.max(this.spacing,3);var p=Math.max(0,this.lineThickness);this.ctx.lineWidth=p;this.ctx.setLineDash&&this.ctx.setLineDash(O(this.lineDashType,p));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===p%2?(b.x<<0)+0.5:b.x<<0,l=1===p%2?(e.x<<0)+0.5:e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,h=this.chart.plotArea.y2+
...
Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),t<v&&(v=t,w=r);else if("stackedBar"===n[0].dataSeries.type)for(var v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),y=t=0,r=w=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,w=r);else y+=n[r].dataPoint.y,t=Math.abs(a-this.parent.convertValueToPixel(y)),t<v&&(v=t,w=r);else if("stackedBar100"===n[0].dataSeries.type)for(var v=
Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),C=y=t=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,w=r);else y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),t=Math.abs(a-this.parent.convertValueToPixel(C)),t<v&&(v=t,w=r);else for(v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),
...
this.label}else if("stackedBar"===this.parent.dataSeries[w].type){v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,t=Math.abs(a-this.parent.convertValueToPixel(y)),t<v&&(v=t,b=r);h=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;this.value=y;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):s(this.options.label)?
ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[w].type){v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));C=y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),t=Math.abs(a-this.parent.convertValueToPixel(C)),t<v&&(v=t,b=r);h=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<
0;this.value=C;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:C}):s(this.options.label)?ea(c?c:C,this.valueFormatString,this.chart._cultureInfo):this.label}else h=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y)<<0,this.value=x.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
...
this.chart.bounds.y2?k.y=this.chart.bounds.y2-k.height:k.y<this.chart.bounds.y1&&(k.y=this.chart.bounds.y1)}else if("left"===this.parent._position||"right"===this.parent._position){f=l=m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:l+p/2};C=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=
n)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,w=0;w<this.parent.dataSeries.length;w++)(v=this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):s(this.options.label)?ya(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):s(this.options.label)?ea(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=x.dataPoint.x;k.y=l+k.fontSize/2-k.measureText().height/
...
this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[w],null!==v.dataPoint.y&&v.dataSeries.visible&&n.push(v));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});x=n[0];b=e=h=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;f=this.chart.plotArea.y1;l=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:l};C=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),
r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({x:a}),v=null,w=0;w<this.parent.dataSeries.length;w++)(v=this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?
k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?ya(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?ea(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);
...
r=y=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,w=r);else y+=n[r].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(y)),t<v&&(v=t,w=r);else if("stackedColumn100"===n[0].dataSeries.type||"stackedArea100"===n[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=C=y=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=
0;x<n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,w=r);else y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),t=Math.abs(d-this.parent.convertValueToPixel(C)),t<v&&(v=t,w=r);else for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=
...
this.chart._cultureInfo):this.label;this.value=x.dataPoint.y[b]}else if("stackedColumn"===this.parent.dataSeries[w].type||"stackedArea"===this.parent.dataSeries[w].type){v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(y)),t<v&&(v=t,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):s(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=y}else if("stackedColumn100"===this.parent.dataSeries[w].type||"stackedArea100"===this.parent.dataSeries[w].type){v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),
t=Math.abs(d-this.parent.convertValueToPixel(C)),t<v&&(v=t,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:C}):s(this.options.label)?ea(c?c:C,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=C}else"waterfall"===this.parent.dataSeries[w].type?(m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<
...
2?(d<<0)+0.5:d<<0,b=this.chart.plotArea.x1,e=this.chart.plotArea.x2,this.bounds={x1:b,y1:f-p/2,x2:e,y2:l+p/2};if("xySwapped"===this.chart.plotInfo.axisPlacement)if("left"===this.parent._position||"right"===this.parent._position){C=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,w=0;w<this.parent.dataSeries.length;w++)(v=
this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):s(this.options.label)?ya(c?
...
this.parent._position||"top"===this.parent._position){C=!1;n="";if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({x:a}),v=null,w=0;w<this.parent.dataSeries.length;w++)(v=this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?c?c:v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?ya(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
...
"top"===this.parent._position?this.parent.convertPixelToValue(a):this.parent.convertPixelToValue(d)}if("bottom"===this.parent._position||"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(h);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(m);q.globalAlpha=g};ma(Z,V);Z.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");
...
for(b=0;b<h.length;b++)h[b].dataPoint.x.valueOf()===c.dataPoint.x.valueOf()&&f.push(h[b]);h=null}else{if(k=this.chart.getDataPointAtXY(a,d,c))this.currentDataPointIndex=k.dataPointIndex,this.currentSeriesIndex=k.dataSeries.index;else if(v)if(k=Wa(a,d,this.chart._eventManager.ghostCtx),0<k&&"undefined"!==typeof this.chart._eventManager.objectMap[k]){k=this.chart._eventManager.objectMap[k];if("legendItem"===k.objectType)return;this.currentSeriesIndex=k.dataSeriesIndex;this.currentDataPointIndex=0<=
...
Z.prototype.highlightObjects=function(a){var d=this.chart.overlaidCanvasCtx;if(s(this.chart.clearedOverlayedCanvas)||"toolTip"===this.chart.clearedOverlayedCanvas)this.chart.resetOverlayedCanvas(),d.clearRect(0,0,this.chart.width,this.chart.height),this.chart.clearedOverlayedCanvas="toolTip";d.save();var c=this.chart.plotArea,b=0;d.beginPath();d.rect(c.x1,c.y1,c.x2-c.x1,c.y2-c.y1);d.clip();for(c=0;c<a.length;c++){var e=a[c];if((e=this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]])&&
...
oa(d,e.funnelSection,0.3,"white"):"candlestick"===b.type?(d.globalAlpha=1,d.strokeStyle=e.color,d.lineWidth=2*e.borderThickness,b=0===d.lineWidth%2?0:0.5,d.beginPath(),d.moveTo(e.x3-b,Math.min(e.y2,e.y3)),d.lineTo(e.x3-b,Math.min(e.y1,e.y4)),d.stroke(),d.beginPath(),d.moveTo(e.x3-b,Math.max(e.y1,e.y4)),d.lineTo(e.x3-b,Math.max(e.y2,e.y3)),d.stroke(),ca(d,e.x1,Math.min(e.y1,e.y4),e.x2,Math.max(e.y1,e.y4),"transparent",2*e.borderThickness,e.color,!1,!1,!1,!1),d.globalAlpha=1):"ohlc"===b.type?(d.globalAlpha=
...
this.chart.height),this.ghostCtx.beginPath())};da.prototype.getNewObjectTrackingId=function(){return++this.lastObjectId};da.prototype.mouseEventHandler=function(a){if("mousemove"===a.type||"click"===a.type){var d=[],c=La(a),b=null;if((b=this.chart.getObjectAtXY(c.x,c.y,!1))&&"undefined"!==typeof this.objectMap[b])if(b=this.objectMap[b],"dataPoint"===b.objectType){var e=this.chart.data[b.dataSeriesIndex],f=e.dataPoints[b.dataPointIndex],h=b.dataPointIndex;b.eventParameter={x:c.x,y:c.y,dataPoint:f,
